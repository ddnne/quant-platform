"""Logical SQLite snapshot identity on an already-open DataPlane connection.

Managed READY-manifest databases recompute the existing Coverage proof on this
connection. Publication, attestation, and snapshot-store writes stay elsewhere.
"""
...
def _manifest_snapshot_state(
    ...
    if row["format"] == RESEARCH_SNAPSHOT_MANIFEST_FORMAT:
        ...
        from storage.coverage_proof import _verify_coverage_manifest
