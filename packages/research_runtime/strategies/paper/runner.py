...
def _reproducibility(
    ...
    *,
    ...
    return {
        ...
        "max_gross_weight_limit": core_md.get("max_gross_weight_limit"),
        "am_order_batch_policy": core_md.get("am_order_batch_policy"),
        "weight_sizing_rule": core_md.get("weight_sizing_rule"),
