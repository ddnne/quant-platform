"""Research-only cost attach + extra-hyp / multi-signal compare.

:func:`attach_research_cost_fields`, :func:`summarize_research_cost`,
:func:`execute_extra_hyp_signals_compare`, and
:func:`execute_multiday_multisignal_compare` live here. Multiday / nextday
eval stays in :mod:`research.single_shot_eval`. Public names are re-exported
from both :mod:`research.single_shot_eval` and :mod:`research.single_shot_job`.
