...
Per-strategy eval and batch orchestration. Screen policy lives in
``research.offline.factory_eval_screen``. Cached panels live in
...
from research.offline.factory_eval_screen import (
