...
Gates, stats, sign-selection, and candidate summary from stitched period
rows. Window stitch / public entry: ``research.offline.multiyear``.
"""
...
from research.offline.bar_eval import _freeze
...
__all__ = ["assemble_class_hyp_multi_year_report"]
