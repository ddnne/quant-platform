...
NEXT_RESEARCH_QUEUE: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "track": EVAL_TRACK_LIQ_LARGE,
        "why": (
            "recorded research/eval/job=eval-inventory-bias-20260824s/ "
            "inventory_bias.json; assert_new_batch_cheap_pb_cap refuses "
            "new batches at 20%; 24s p10×eps×px thin-exclude not sleeve "
            "(event_fund at 5); GOOD stays flatten×sales_down"
        ),
        "not_a_pass": True,
        "go": False,
    },
    ...
    },
    {
        ...
        "track": EVAL_TRACK_LIQ_LARGE,
        "why": (
            "eval-occupancy-audit-20260824s: 24s p10×eps×px both-track thin; "
