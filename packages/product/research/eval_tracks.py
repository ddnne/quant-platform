...
NEXT_RESEARCH_QUEUE: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "why": (
            ...
            "new batches at 20%; 24bn flatten×sales×px thin exclude (~0.092/0.104)"
        ),
        "not_a_pass": True,
        "go": False,
    },
    ...
    },
    {
        ...
        "track": EVAL_TRACK_LIQ_LARGE,
        "why": (
            "eval-occupancy-audit-20260824bn both tracks: flatten×sales×px "
            "~0.092/0.104 thin exclude; not a pass"
        ),
        "not_a_pass": True,
        "go": False,
    },
