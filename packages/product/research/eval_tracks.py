...
NEXT_RESEARCH_QUEUE: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "why": (
            ...
            "new batches at 20%; 24by pb×eps×invert thin exclude (~0.101/0.107)"
        ),
        "not_a_pass": True,
        "go": False,
    },
    ...
    },
    {
        ...
        "track": EVAL_TRACK_LIQ_LARGE,
        "why": (
            "eval-occupancy-audit-20260824by both tracks: pb×eps×invert "
            "~0.101/0.107 thin exclude; not a pass"
        ),
        "not_a_pass": True,
        "go": False,
    },
