...
NEXT_RESEARCH_QUEUE: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "why": (
            ...
            "new batches at 20%; 24bi flatten×eps×sales material (~0.188)"
        ),
        "not_a_pass": True,
        "go": False,
    },
    ...
    },
    {
        ...
        "track": EVAL_TRACK_LIQ_LARGE,
        "why": (
            "eval-occupancy-audit-20260824bi both tracks: flatten×eps×sales "
            "~0.188/0.188 material not sleeve; flatten_eps band not exceeded; not a pass"
        ),
        "not_a_pass": True,
        "go": False,
    },
