...
NEXT_RESEARCH_QUEUE: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "why": (
            ...
            "new batches at 20%; 24cc pb×sales×tight near_empty park (~0.037/0.043)"
        ),
        "not_a_pass": True,
        "go": False,
    },
    ...
    },
    {
        ...
        "track": EVAL_TRACK_LIQ_LARGE,
        "why": (
            "eval-occupancy-audit-20260824cc both tracks: pb×sales×tight "
            "~0.037/0.043 near_empty parked; not a pass"
        ),
        "not_a_pass": True,
        "go": False,
    },
