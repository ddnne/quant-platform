...
NEXT_RESEARCH_QUEUE: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "why": (
            ...
            "new batches at 20%; 24bw p10×invert×px thin exclude (~0.070/0.077)"
        ),
        "not_a_pass": True,
        "go": False,
    },
    ...
    },
    {
        ...
        "track": EVAL_TRACK_LIQ_LARGE,
        "why": (
            "eval-occupancy-audit-20260824bw both tracks: p10×invert×px "
            "~0.070/0.077 thin exclude; not a pass"
        ),
        "not_a_pass": True,
        "go": False,
    },
