...
NEXT_RESEARCH_QUEUE: tuple[dict[str, Any], ...] = (
    ...
    {
        "id": "single_shot_eval_shrink",
        "track": EVAL_TRACK_MID_N,
        "why": "single_shot_eval.py ~1909 after execute_* extract; still W56 not daily_path",
        "not_a_pass": True,
        "go": False,
    },
    {
        ...
        "track": EVAL_TRACK_MID_N,
        "why": "eval_harness.py ~2220 is W56 next-day; candidate SoT is daily_path",
        "not_a_pass": True,
        "go": False,
    },
    {
        ...
        "track": EVAL_TRACK_MID_N,
        "why": "cost_models.py ~2281 is live ADV/liquidity/short math; do not fake-split",
        "not_a_pass": True,
        "go": False,
    },
    {
        "id": "complete21_min_module_split",
        "track": EVAL_TRACK_MID_N,
        "why": "tests split; packages/research_runtime/features/complete21_min.py ~1201 still one module",
        "not_a_pass": True,
        "go": False,
    },
    {
