...
NEXT_RESEARCH_QUEUE: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "why": (
            ...
            "new batches at 20%; 24bh flatten×eps×np material (~0.120/0.127)"
        ),
        "not_a_pass": True,
        "go": False,
    },
    ...
    },
    {
        ...
        "track": EVAL_TRACK_LIQ_LARGE,
        "why": (
            "eval-occupancy-audit-20260824bh both tracks: flatten×eps×np "
            "~0.120/0.127 material not sleeve; flatten_eps band not exceeded; not a pass"
        ),
        "not_a_pass": True,
        "go": False,
    },
