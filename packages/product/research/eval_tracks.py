...
NEXT_RESEARCH_QUEUE: tuple[dict[str, Any], ...] = (
    {
        ...
        "why": "YAML is declaration SoT with params.gates; _SPECS remains typed runtime until loader replaces it",
        "not_a_pass": True,
        "go": False,
    },
    {
        ...
        "why": "universe+sqlite loaders extracted; class_hyp_eval still holds W78-W86 evaluate_*_on_bars",
        "not_a_pass": True,
        "go": False,
    },
    {
        ...
        "track": EVAL_TRACK_LIQ_LARGE,
        "why": "CF period-net no longer imports factory; 5k-line factory remains for offline W87-W89 tests",
        "not_a_pass": True,
        "go": False,
    },
    {
        ...
        "track": EVAL_TRACK_LIQ_LARGE,
        "why": "7 PYTHON_ONLY_EVENT_GATES need Worker bodies or an explicit skip catalog; names-only would empty occupancy",
        "not_a_pass": True,
        "go": False,
    },
    {
