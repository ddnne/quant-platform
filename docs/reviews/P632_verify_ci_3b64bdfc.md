...
**Requested base:** `3b64bdfc9a41be76a6e4e881aaea1ff9751443ed` (`origin/grok/phase63-ci-source-closure`)  
**Isolation worktree:** `/private/tmp/qp-p632-verify-ci-3b64bdfc` on `grok/p632-verify-ci-3b64bdfc` (do not push `main`)  
**PASS SHA:** `3b64bdfc9a41be76a6e4e881aaea1ff9751443ed` (as-is; no local code fixes)  
**Fetched:** 2026-08-23T16:08:54Z  
...
| Gate | Status |
|------|--------|
| `scripts/verify_ci.sh` at `3b64bdfc` as-is | **PASS** (code lane) |
...
| `pytest tests/` | **1499 passed, 4 skipped, 0 failed** in 100.07s |
| catalog compile + `catalog_ids` freeze | pass |
| Evaluation IR `schema.json` + golden codec (generated freeze) | pass |
...
Workers: `ingestion-jsda` (2 tests), `ingestion-premium` (6), `ingestion-secrets` (2), `quant-ops-mcp` (27), `research-ai-gateway` (30), `research-mass-eval` (76), `ci-aggregate` (13).

Wall clock: 206.65s (`real`). Exit code: **0**. Log: `/tmp/qp-p632-verify-ci-3b64bdfc-logs/verify_ci.log`.
