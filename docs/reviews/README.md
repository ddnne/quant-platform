...
> **Live vs freeze.** Feature HEAD `a7d1e93d` vs `origin/main` `b5c326a`. PR #1 is **BLOCKED** until `ci-aggregate` posts. Live MCP: Projection **STALE**, READY **null**. Historical A01 / A07 / A11 files are remaining-audit **freezes** at `03cd1b1`, not live SoT. `f224e7e` / `40d1aa90` / `67fcbd7c` / `ed94d504` / `5103b26b` / wave-7 (`3b64bdfc`) / wave-8 / `0a8ced34` / `242c2484` / wave-9 / `2b82ec7d` / wave-10 / `02fb6cbd` / wave-11 / `cf7da56c` / wave-12 / `b5f6f2de` / wave-13 review files stay earlier freezes, not live HEAD.
...
- [`P632_ind_A_revisit_b1605c36.md`](P632_ind_A_revisit_b1605c36.md) / [`P632_verify_ci_b1605c36.md`](P632_verify_ci_b1605c36.md) — Independent A and `verify_ci` at `b1605c36` (later code HEAD `a7d1e93d`)
