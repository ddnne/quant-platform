...
> **Live vs freeze.** Feature HEAD `b5f6f2de` vs `origin/main` `b5c326a`. PR #1 is **BLOCKED** until `ci-aggregate` posts. Live MCP: Projection **STALE**, READY **null**. Historical A01 / A07 / A11 files are remaining-audit **freezes** at `03cd1b1`, not live SoT. `f224e7e` / `40d1aa90` / `67fcbd7c` / `ed94d504` / `5103b26b` / wave-7 (`3b64bdfc`) / wave-8 / `0a8ced34` / `242c2484` / wave-9 / `2b82ec7d` / wave-10 / `02fb6cbd` / wave-11 / `cf7da56c` / wave-12 review files stay earlier freezes, not live HEAD.
...
**This HEAD:** `b5f6f2de` (later than wave-12). **`origin/main`:** `b5c326a` (not merged). PR #1 **BLOCKED** until `ci-aggregate` posts. Live MCP: Projection **STALE**, READY **null**. Historical 6.3.1 files above (A01 / A07 / A11 included) are not live OPEN/CLOSED or live SoT for 6.3.2. `f224e7e` / `40d1aa90` / `67fcbd7c` / `ed94d504` / `5103b26b` / wave-7 (`3b64bdfc`) / wave-8 / `242c2484` / wave-9 / `2b82ec7d` / wave-10 / `02fb6cbd` / wave-11 / `cf7da56c` review files stay earlier freezes, not live HEAD. See:
...
- [`P632_wave12_status.md`](P632_wave12_status.md) — A–S freeze vs `cf7da56c`; later HEAD is `b5f6f2de`
