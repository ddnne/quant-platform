...
**Live strategy at `2b82ec7d`:** §10 — remaining extracts vs HOLD. YAML
...
## 10. Current remaining extracts vs HOLD (HEAD 2b82ec7d)
...
Measured at `2b82ec7d`: tracked paths **802**; catalog YAML
...
(`2323f6a5`; `cf_premium_backfill` uses it at `2b82ec7d`).
