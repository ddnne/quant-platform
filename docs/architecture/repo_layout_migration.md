...
├── coverage/        # write_collection_receipts, refresh_coverage_ledger, evaluate_collection_sla, issue_signed_*
├── paper/           # run_paper_once, run_agents_paper_once, rebuild_paper_index
