...
3. **CF real multi-year** — mode `r2_panels` · job **`w92-opt225-20260817T231531Z`** · status **ok** · 14 logics × 6 periods · stage 6/6 · opt225 signal path `c21_opt225_*_xs` · R2 written  
...
3. **CF real-data mass-eval** — **executed** · job_id **`w92-opt225-20260817T231531Z`** · mode **`r2_panels`**  
...
| real CF job executed | **yes** · `w92-opt225-20260817T231531Z` |
