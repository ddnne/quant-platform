...
**Code tip:** `3191e2b9a0b9eec69c5d803ea876293f67337586`  
**Prior tip:** W95 `942a43d` · OTC tip underneath `a780fb9`  
**Primary proofs:**  
...
2. **Failure-constrained new hyps** — `llm-hyp-generator/v1.1` hard constraints + reject gate · xAI grok-4.6 **n_proposed=8 / n_accepted=8 / n_evaluated=8 / n_survivors=5** · catalog fallback disclosed · **do not** promote demoted/weak as main  
3. **Frozen 3-default quality** — pins **unchanged** · local RC all true · CF job **`w96-defaults-20260818T141855Z`** `r2_panels` · **2 contradictions recorded only** (PROMOTE weaker on CF vs KEEP; fund KEEP weak+inverted on CF) · **no retune**  
...
| `hyp_xai_eval.json` | Track B xAI hyps + propose_profit_hypotheses |
| `w96-defaults-20260818T141855Z` | Track C CF `r2_panels` frozen defaults |
| `defaults_quality.json` | KEEP/PROMOTE contradiction record |
...
| Contradictions recorded only | **yes** (2) |
