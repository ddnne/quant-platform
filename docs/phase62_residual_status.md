...
- **mid_n_explore** (ADV 80): `eval-cf-dp-basket-alts-20260824dp-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-basket-alts-20260824dp-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v138-24do-plus22` (`cce6b7e3-3d1c-497c-bc2e-2bf89ddc3c8a`). Baskets keep `eval-cf-dp-both-sleeves-20260824df` (`eval-basket-decision-20260824dp` fund×event + invert-print + CS alts mid/liq 72/72; theme_flow keep 4th 0.426; CS occupancy is not a flow replace). `basket_theme_invert` primary=False, not mixed into theme_repo. Cost/risk `eval-usable-cost-risk-20260824dp` not_a_pass. Usable `eval-usable-inventory-20260824dp` n_usable 1724. event 3-AND +N **stopped** (rate parent exhausted; flow-fill not written). Combo jsonl dump R2 `eval-combo-jsonl-20260824dp` yaml_remains_sot. Deleted 12 uncited w0814h/w0815 proofs. Propose `eval-cf-propose-20260824dp` llm_failed 0-adopt (not soup). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
