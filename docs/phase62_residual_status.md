...
**Live verified:** 2026-08-18 · **W95** options_225 **shape deep-dive** (skew / CM-term / ΔBaseVol) + **rate/flow/fund failure decomp** · **BaseVol = canonical level** · ATM **compare-only** · spread **off-mainline** (non-informative) · series **v1.2** · factory **v2.5** · class-signals **v10** · cf-mass-eval **v6** · worker **v6** · CF shape job **`w95-shape-20260818T133241Z`** · decomp job **`w95-decomp-20260818T133302Z`** · mode **`r2_panels`** (NOT synthetic-as-final) · shape stance **WEAK / not main candidate** · 2020–22 **level dead / shape alive** · rate/flow **weak_thesis** · **sign flips** · fund2017 **ARTIFACT** (t≈153) · low-var **t-gate** · demoted **`fund_value_mom_agree_slow`** · thick survivors **8→7** · SoT **`derivatives_bars_daily_options_225`** · **do not claim smile/surface ≡ level** · TOPIX RV **proxy only** · options_225 **SoT** · W94 underneath held · **3 defaults frozen** · near-groups **parallel** · human main **NOT selected** · **GO deferred** · Mass/READY/Phase7/ops GO **NO-GO/未宣言/OFF/未宣言** · continuous paper **UNARMED** · COMPLETE **22** held · DEFER **4** · **no invent** · **no Mass/READY ON** · **no operational GO** · **no live** · **no simple_daily_sign mass** · **no hold/mom/frac grid** · **no synthetic-as-final** · proofs [`w0818e_w95_shape_factor_decomp_20260818.md`](proof/w0818e_w95_shape_factor_decomp_20260818.md) · [`w0818e_w95_shape_deepdive_20260818.md`](proof/w0818e_w95_shape_deepdive_20260818.md) · [`w0818e_w95_residual_close_20260818.md`](proof/w0818e_w95_residual_close_20260818.md)  
**Repo tip:** `43b4ba8a72568180f0d00266bba5784055046bde` — W95 residual tip pin to latest post-pin HEAD · COMPLETE **22** / DEFER **4** / Mass/READY/ops GO **NO-GO/未宣言/未宣言** · continuous paper **UNARMED** · 3 defaults **frozen** · projection **FRESH**

## Research entry (W74 · … · W90 · real CF + Nikkei vol proxy W91 · options_225 BaseVol/ATM SoT W92 · BaseVol↔ATM differential W93 · skew/CM-term/ΔBaseVol + thick W94 · shape deep-dive + rate/flow/fund decomp W95)
...
**GO final gates:** [`docs/proof/w0816u_w86_go_gates_20260817.md`](proof/w0816u_w86_go_gates_20260817.md) · GO = **pre-live-order final gate** · **repo + compare table required before GO consideration** · operational GO **未宣言** · **W95 GO judgment deferred**  
**Status:** research entry **linked** under COMPLETE **22** · Mass/READY/Phase7/operational GO **NO-GO/未宣言/OFF/未宣言** · factory = **logic diversification** + **real CF multi-year mass-eval** + **options_225 shape deep-dive (WEAK / not main)** + **rate/flow/fund decomp** (fund2017 artifact demoted · low-var t-gate · survivors 8→7) + **canonical BaseVol level** + **index vol proxy** (not grid mass · not Mass ON) · **3 default production research_candidates frozen** (xs hold=10 mom=5 · xs hold=10 mom=3 · fund hold=10 mom=10; **not retuned this wave**; **not** Mass/READY) · factory survivors **≠** production research_candidate · StrategySpec **v3** · continuous paper **UNARMED**
