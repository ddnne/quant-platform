...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824cv-unclass-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824s-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824cv-unclass-liq_large`, `eval-cf-dp-both-sleeves-20260824s-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v120-24cv-unclass-occupancy` (`ab16266d-9a14-42ce-8fe8-a70a0f40cd46`). Baskets `eval-cf-dp-both-sleeves-20260824s` not_a_pass. Durability `eval-durability-summary-20260824t` not_a_pass. Usable `eval-usable-inventory-20260824cv` n_usable 108 (was 54). near_empty park 42. Thin sleeve exclude 66. always_on park 2. Occupancy unclass-80 + prefer3. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
