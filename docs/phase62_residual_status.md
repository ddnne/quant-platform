...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824ai-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824ai-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v66-24aq-margin-squeeze` (`5018a38d-6a53-4b6c-88a3-dfd5b62c7c17`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 18. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824ai`. Inventory `eval-inventory-bias-20260824ai`. Propose 24aq: 0-adopt clone tight×price (8B again; 70B/glm did not land); margin-squeeze extra-title; invoke timeout default 300s; no soup. GOOD stays eps×sales. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
