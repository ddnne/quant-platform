...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824cr-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824s-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824cr-liq_large`, `eval-cf-dp-both-sleeves-20260824s-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v118-24cr-flatten-eps-up` (`1bc495ed-ffea-4a2a-b43b-f2fd39f229b0`). Baskets `eval-cf-dp-both-sleeves-20260824s` not_a_pass (event_fund 5th is flatten_eps_up; majority is not a pass). Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. Thin/park 2-AND parents are SPARSE. near_empty park 33. Thin sleeve exclude 38. Occupancy `eval-occupancy-audit-20260824cq` eps×np×invert ~0.160/0.169 material; `eval-occupancy-audit-20260824cr` flatten×eps_up ~0.322/0.328 thicker than flatten_eps ~0.28. Inventory `eval-inventory-bias-20260824ai`. Propose 24cp 0-adopt parent-sparse; 24cq/24cr material. GOOD rotated eps×sales×invert. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
