...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-adopt1s-20260823s`, `eval-cf-dp-both-sleeves-20260823q-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-adopt1s-20260823s`, `eval-cf-dp-both-sleeves-20260823q-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v32-propose-polar-sparse` (`6d490b8f-1e61-4c57-8aca-fb1ee0a2a333`). Baskets `eval-cf-dp-both-sleeves-20260823q` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 11. Occupancy `eval-occupancy-audit-20260823s` material-band. Inventory `eval-inventory-bias-20260823s`. Propose 23s clones 2; occupancy YAML `event_p10_pb_rising` (not ROE-decline slang). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py`.
