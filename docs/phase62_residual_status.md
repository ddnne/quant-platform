...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bq-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bq-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v92-24bq-p10-pb-invert` (`71b63e5c-24aa-44ac-96b0-0c93771bc8c1`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 24. Thin sleeve exclude 24. Occupancy `eval-occupancy-audit-20260824bq` (p10×pb×invert ~0.064/0.073 thin exclude). Inventory `eval-inventory-bias-20260824ai`. Propose 24bq: adopt `event_p10_pb_invert` occupancy-equal thin. GOOD rotated p10×pb×price. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
