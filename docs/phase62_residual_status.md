...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824df-b0-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824df-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824df-b0-liq_large`, `eval-cf-dp-both-sleeves-20260824df-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v129-24df-plus61` (`b084e414-a640-4d91-8dee-077687e21cd6`). Baskets `eval-cf-dp-both-sleeves-20260824df` not_a_pass (usable members). Durability `eval-usable-read-20260824df` not_a_pass. Usable `eval-usable-inventory-20260824df` n_usable 1210 (was 1149). near_empty park 63. Thin sleeve exclude 184. always_on park 7. 24df +61 (60 surprise_xs + 1 event adopt; 61 material / 0 thin; non-event share 98.4%). Deleted 10 uncited `docs/proof` ops/tip-densify logs. Propose `eval-cf-propose-20260824df` llm_failed n_adoptable 0 auto_inject false (non-event hand templates already occupancy-counted). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
