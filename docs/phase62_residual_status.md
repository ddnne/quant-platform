...
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v138-24do-plus22` (`cce6b7e3-3d1c-497c-bc2e-2bf89ddc3c8a`). Baskets keep `eval-cf-dp-both-sleeves-20260824df` (`eval-basket-decision-20260824ds` unused non-nested flow alts mid/liq 66/66; min lo below flow 4th 0.426; calendar skip dropped). invert sleeve primary=False. Cost/risk `eval-usable-cost-risk-20260824ds` not_a_pass. Usable `eval-usable-inventory-20260824ds` n_usable 1724. event 3-AND +N **stopped**. Combo jsonl `eval-combo-jsonl-20260824ds` yaml_remains_sot. Deleted 12 uncited w0815f-i proofs. Propose `eval-cf-propose-20260824ds` n_adoptable 2 not written (n_pri=1 / missing 2-AND parents). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
