...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824ar-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824ar-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v68-24ar-eps-sales` (`97628e4f-ef8b-47b6-8898-df576a7b62ed`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 18. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824ar` (eps×sales ~0.287 both tracks, same band as flatten_eps, no sleeve swap). Inventory `eval-inventory-bias-20260824ai`. Propose 24ar: adopt `event_eps_down_sales_down` occupancy-equal (70B after avoid-filter). GOOD rotated np×sales. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
