...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-plus32vf-20260823h`, `eval-cf-dp-mid80-adopt1h-20260823h`, `eval-cf-dp-both-sleeves-20260823e-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-plus32vf-20260823h`, `eval-cf-dp-liq100-adopt1h-20260823h`, `eval-cf-dp-both-sleeves-20260823e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v31-propose-parse`. Durability summary (not_a_pass, go=false) `research/eval/job=eval-durability-summary-20260823h/durability_summary.json` from both-sleeves-20260823e. Inventory `research/eval/job=eval-inventory-bias-20260823h/inventory_bias.json`. Propose `eval-cf-propose-llm-20260823h` 70B n_adoptable=1 (2 clones rejected). Adopt `event_eqar_rising_ta_up`. Importer graph `research/eval/job=eval-deadcode-graph-20260823h/importer_graph.json`. unique22 5/17. cheap_pb primary cap code-enforced. GO deferred. Deleted 17 orphan pyc (already-removed tests). HOLD: cost_models / options_225 / daily_path leftover / factory OFF / unique22 park YAML.
