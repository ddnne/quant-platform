...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824dl-b0-mid_n_explore`, `eval-cf-dp-basket-alts-20260824dl-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824dl-b0-liq_large`, `eval-cf-dp-basket-alts-20260824dl-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v135-24dl-plus64` (`dd18fa6e-0da7-4747-8510-0ea2aecc6a60`). Baskets keep `eval-cf-dp-both-sleeves-20260824df` (`eval-basket-decision-20260824dl` 3 event 3-AND alts mid/liq 60/60, keep: min lo below flow 4th 0.426). Cost/risk `eval-usable-cost-risk-20260824dl` not_a_pass. Usable `eval-usable-inventory-20260824dl` n_usable 1574 (was 1510). near_empty park 63. Thin sleeve exclude 213. always_on park 7. 24dl +64 event 3-AND (64 material / 0 thin; surprise_xs share of new 0%; vol 22 / flow 22 / rate 20). Deleted 12 uncited w0814 collect proofs. Propose `eval-cf-propose-20260824dl` llm_failed 0-adopt (not soup). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
