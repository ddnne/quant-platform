...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bm-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bm-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v88-24bm-flatten-sales-tight` (`60713432-f771-4d72-82d0-cea89091325f`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 22. Thin sleeve exclude 22. Occupancy `eval-occupancy-audit-20260824bm` (flatten×sales×tight ~0.084/0.088 thin exclude). Inventory `eval-inventory-bias-20260824ai`. Propose 24bm: adopt `event_flatten_sales_tight` occupancy-equal thin. GOOD rotated flatten×sales×price. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
