...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824cc-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824cc-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v104-24cc-pb-sales-tight` (`9517a4d6-6a06-4a8f-b4f8-9980b3dcf28a`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 29. Thin sleeve exclude 31. Occupancy `eval-occupancy-audit-20260824cc` (pb×sales×tight ~0.037/0.043 near_empty park). Inventory `eval-inventory-bias-20260824ai`. Propose 24cc: adopt then park `event_pb_sales_tight`. GOOD rotated pb×sales×price. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
