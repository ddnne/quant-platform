...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824ab-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824ab-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v52-24ab-adopt` (`f31cc6d4-763b-4cc4-a7e6-6d8f156d1dde`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park includes 24ab p10×np. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824ab`. Inventory `eval-inventory-bias-20260824ab`. Propose 24ab: GOOD p10×np adopted then both-track near_empty parked; GOOD rotated to p10×invert. price-is-low occupancy-label. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
