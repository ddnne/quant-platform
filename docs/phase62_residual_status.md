...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-plus28q-20260823l`, `eval-cf-dp-mid80-adopt2l-20260823l`, `eval-cf-dp-both-sleeves-20260823e-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-plus28q-20260823l`, `eval-cf-dp-liq100-adopt2l-20260823l`, `eval-cf-dp-both-sleeves-20260823e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v31-propose-parse`. plus32vf 4 near_empty parked (`NEAR_EMPTY_PARK_IDS`; not countable / not basket). plus28q occupancy `eval-occupancy-audit-20260823l` material near_empty 0. Inventory `eval-inventory-bias-20260823l`. Propose 23l 70B adopt 2 / polarity 1. Importer HOLD `eval-deadcode-graph-20260823l` (0 tracked unused). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py`.
