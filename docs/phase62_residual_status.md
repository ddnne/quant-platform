...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824az-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824az-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v76-24az-flatten-p10-eps` (`f5368c3f-3857-4562-b6ea-ab9e66e87005`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 19. Thin sleeve exclude 15. Occupancy `eval-occupancy-audit-20260824az` (flatten×p10×eps ~0.036/0.053 mixed thin exclude; not both-track near_empty). Inventory `eval-inventory-bias-20260824ai`. Propose 24az: adopt `event_flatten_p10_eps_down` occupancy-equal; row1 total-assets extra-title 0-adopt. GOOD rotated flatten×p10×sales. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
