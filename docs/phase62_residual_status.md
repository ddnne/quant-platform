...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824ax-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824ax-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v74-24ax-invert-px` (`2290956c-70f3-4014-9f7b-8b1699894367`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 18. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824ax` (invert×px ~0.272/0.276 material, flatten_eps band, no sleeve swap). Inventory `eval-inventory-bias-20260824ai`. Propose 24ax: adopt `event_invert_px_down` occupancy-equal. GOOD fallback unique 3-AND flatten×p10×pb. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
