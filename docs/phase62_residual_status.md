...
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v125-24db-plus120` (`4ec8b7ef-37cf-4562-bacd-0e3f39e49128`). Baskets `eval-cf-dp-both-sleeves-20260824cz` not_a_pass (usable members). Durability `eval-durability-summary-20260824t` not_a_pass. Usable `eval-usable-inventory-20260824db` n_usable 756 (was 652). near_empty park 63. Thin sleeve exclude 177. always_on park 7. 24db +120 2-AND occupancy (104 material / 13 thin / 3 empty; event share 33%). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
