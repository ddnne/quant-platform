...
**Live verified:** 2026-08-18 · **W93** options_225 BaseVol vs ATM IV **differential** + multi-year windows (2017–2019 / 2020–2022 / 2023–2025 honest shards) + spread autopsy + ATM **min_dte=6** fix (series **v1.1** · corr≈**0.99994** · exact-zero spread≈**99.76%**) + CF thickened `r2_panels` · factory **v2.4** · class-signals **v9** · cf-mass-eval **v4** · CF job **`w93-opt225-20260818T120810Z`** · corroborating **`w93-opt225-20260818T121627Z`** (full 8 logics × windows) · **`w93-thicken-20260818T121404Z`** · mode **`r2_panels`** (NOT synthetic-as-final) · CF survivors **2** · R2 `research/mass_eval/job=w93-opt225-20260818T120810Z/` · panels thicken DONE (repo/margin/short/fins/calendar + options_225 + equities bars) · SoT **`derivatives_bars_daily_options_225`** · spread **`atm_iv − base_vol`** · BaseVol≡ATM on matched transforms post-fix · spread logics **non-informative** at frozen thresholds · TOPIX RV **proxy only** · options_225 **SoT** · W92 underneath · **3 defaults frozen** · near-groups **parallel** · human main **NOT selected** · **GO deferred** · Mass/READY/Phase7/ops GO **NO-GO/未宣言/OFF/未宣言** · continuous paper **UNARMED** · COMPLETE **22** held · DEFER **4** · **no invent** · **no Mass/READY ON** · **no operational GO** · **no live** · **no simple_daily_sign mass** · **no hold/mom/frac grid** · **no synthetic-as-final** · proofs [`w0818c_w93_opt225_basevol_atm_diff_20260818.md`](proof/w0818c_w93_opt225_basevol_atm_diff_20260818.md) · [`w0818c_w93_residual_close_20260818.md`](proof/w0818c_w93_residual_close_20260818.md)  
**Repo tip:** `658ff6db857550c96e9011b5ff2e8da2a473f7ff` — W93 residual tip pin to track B / thicken harden HEAD · COMPLETE **22** / DEFER **4** / Mass/READY/ops GO **NO-GO/未宣言/未宣言** · continuous paper **UNARMED** · 3 defaults **frozen** · projection **FRESH**
...
**Stats bar:** `research-stats-metrics/v1` · class-signals **v9** · W81 stats floors held · W82 PIT held · W84 paper align · W85 multi-window · W86 sign+repo+compare · W87 mass factory · W88 logic-diversity · W89 rate+multifactor · W90 LLM+CF · W91 real CF + nky vol **proxy** · W92 options_225 BaseVol/ATM SoT · **W93 BaseVol↔ATM differential + multi-year windows + CF thicken** (`mass-strategy-factory/v2.4` · `cf-mass-eval-job/v4` · options series **v1.1**)  
**Options vol differential + windows (W93):** [`docs/proof/w0818c_w93_opt225_basevol_atm_diff_20260818.md`](proof/w0818c_w93_opt225_basevol_atm_diff_20260818.md) · residual close [`w0818c_w93_residual_close_20260818.md`](proof/w0818c_w93_residual_close_20260818.md) · recipe `scripts/run_w93_opt225_diff_windows.py` · logs [`.glm-logs/w0818c_w93_opt225_diff/`](../.glm-logs/w0818c_w93_opt225_diff/) · CF mode **`r2_panels`** · job **`w93-opt225-20260818T120810Z`** · corroborating **`w93-opt225-20260818T121627Z`** · **`w93-thicken-20260818T121404Z`** · min_dte=**6** · SoT **`derivatives_bars_daily_options_225`** · TOPIX RV **proxy only**  
...
**GO final gates:** [`docs/proof/w0816u_w86_go_gates_20260817.md`](proof/w0816u_w86_go_gates_20260817.md) · GO = **pre-live-order final gate** · **repo + compare table required before GO consideration** · operational GO **未宣言** · **W93 GO judgment deferred**  
**Status:** research entry **linked** under COMPLETE **22** · Mass/READY/Phase7/operational GO **NO-GO/未宣言/OFF/未宣言** · factory = **logic diversification** + **real CF multi-year mass-eval** + **options_225 vol differential (canonical)** + **index vol proxy** (not grid mass · not Mass ON) · **3 default production research_candidates frozen** (xs hold=10 mom=5 · xs hold=10 mom=3 · fund hold=10 mom=10; **not retuned this wave**; **not** Mass/READY) · factory survivors **≠** production research_candidate · StrategySpec **v3** · continuous paper **UNARMED**
