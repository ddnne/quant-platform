...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bv-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bv-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v97-24bv-p10-sales-px` (`9c61297e-b198-450c-aa79-a8df5017df97`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 27. Thin sleeve exclude 26. Occupancy `eval-occupancy-audit-20260824bv` (p10×sales×px ~0.045/0.045 near_empty park). Inventory `eval-inventory-bias-20260824ai`. Propose 24bv: adopt then park `event_p10_sales_px_down`; row1 steep polarity 0-adopt. GOOD rotated p10×invert×price. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
