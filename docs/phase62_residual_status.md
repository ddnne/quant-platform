...
**Live verified:** 2026-08-20 · **W104 ALL-TRACK** OTC Batch8 **5152→5252 (+100)** · PARTIAL **3632→3532** · span **2005-03-08…2026-08-20** · tip `S260821+` 404 wait · NEW unique_logic hyps **4/4/4** (`event_funding_stress_skip` / `curve_steep_event_confirm` headline · **catalog-map-only hyps are not the headline**) · `xs_cs_dispersion_gate` **RESEARCH_ONLY** (worst **−11.4%**) · sticky **STABLE_RESEARCH_ONLY** (worst **−14.4%**) · **no extra gate grid this wave** · repo-linked short **still applies** (overnight · 738/738 · gaps=0 · no ffill) · W100 pack **stands 6/6/3** · W101 **3/3/3** · W102 **4/4/2** · W103 **4/3/3** · master MISDATE **KEEP PARTIAL** (220/21 · sealed 0 · no floor raise) · projection **FRESH** (`projgen-6424a4bc0c0b4a75bfd6159c7fa0ef0b`) · promote_as_main **false** · go **false** · frozen **3-default pins unchanged** · **no hold/mom micro-grid** · daily_path_DD **mandatory** · llm-hyp **v1.1** · **3 defaults frozen** · human main **NOT selected** · **GO deferred** · Mass/READY/Phase7/ops GO **NO-GO/未宣言/OFF/未宣言** · continuous paper **UNARMED** · COMPLETE **22** held · DEFER **4** · OTC dataset **PARTIAL** · COMPLETE segs **5252** · platform segs **8641** · **no invent** · **no empty COMPLETE** · **no fake densify** · **no Mass/READY ON** · **no operational GO** · **no live** · proofs [`w0820a_w104_residual_close_20260820.md`](proof/w0820a_w104_residual_close_20260820.md) · [`w0820a_w104_otc_backfill_batch8_20260820.md`](proof/w0820a_w104_otc_backfill_batch8_20260820.md) · [`w0820a_w104_hyps_new_logic_20260820.md`](proof/w0820a_w104_hyps_new_logic_20260820.md) · W103 [`w0819f_w103_residual_close_20260819.md`](proof/w0819f_w103_residual_close_20260819.md)
**Repo tip:** `4bee9eba2a1589adccd602f83d22fdb02c58cab4` — W104 ALL-TRACK close · OTC Batch8 **5252** / PARTIAL **3532** · hyps W100 **6/6/3** + W101 **3/3/3** + W102 **4/4/2** + W103 **4/3/3** + W104 **4/4/4 unique_logic** · catalog maps **not headline** · no extra gate grid · repo short still applies · sticky **STABLE_RESEARCH_ONLY** · MISDATE **KEEP PARTIAL** · Mass/READY/ops GO **NO-GO/未宣言/未宣言** · continuous paper **UNARMED** · 3 defaults **frozen** · projection **FRESH**

## Research entry (W74 · … · W90 · real CF + Nikkei vol proxy W91 · options_225 BaseVol/ATM SoT W92 · BaseVol↔ATM differential W93 · skew/CM-term/ΔBaseVol + thick W94 · shape deep-dive + rate/flow/fund decomp W95 · OTC tip + hyps + defaults W96 · OTC planned PARTIAL backfill + survivor deep + hyps W97 · sticky deep + hyps continue W98 · OTC Batch3 + sticky true daily DD + hyps W99 · OTC Batch4 + daily_path_DD gate + peer daily DD + hyps W100 · OTC Batch5 + continue-hyps + vol daily DD W101 · OTC Batch6 + event/rate daily DD + gate quality + hyps W102 · OTC Batch7 + repo short + gate deepen + hyps W103 · OTC Batch8 + NEW unique_logic hyps + gate confirm (no extra grid) W104)

**OTC Batch8 + NEW unique_logic hyps + gate/sticky confirm + repo-short confirm (W104 ALL-TRACK):** OTC [`w0820a_w104_otc_backfill_batch8_20260820.md`](proof/w0820a_w104_otc_backfill_batch8_20260820.md) · hyps [`w0820a_w104_hyps_new_logic_20260820.md`](proof/w0820a_w104_hyps_new_logic_20260820.md) · residual close [`w0820a_w104_residual_close_20260820.md`](proof/w0820a_w104_residual_close_20260820.md) · recipe `scripts/run_w104_new_hyps_daily_dd.py` · `scripts/run_w103_repo_short_cost.py` (confirm) · logs [`.glm-logs/w0820a_w104_otc8_new_hyps/`](../.glm-logs/w0820a_w104_otc8_new_hyps/) · OTC **5152→5252 (+100)** · PARTIAL **3632→3532** · span **2005-03-08…2026-08-20** · tip `S260821+` 404 · NEW unique_logic **4/4/4** (headline `event_funding_stress_skip` / `curve_steep_event_confirm` · **catalog-map-only hyps are not the headline**) · **no extra gate grid this wave** · gate **RESEARCH_ONLY** (worst **−11.4%**) · sticky **STABLE_RESEARCH_ONLY** · repo overnight still applies (gaps=0) · MISDATE **KEEP PARTIAL 220/21** · 3 defaults **frozen / pins untouched** · promote/GO **false** · implementer **GLM5.3** (Grok not implement)
