...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824ay-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824ay-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v75-24ay-flatten-p10-pb` (`9d01401d-22b8-4ce6-ae30-a3d0079cd36f`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 19. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824ay` (flatten×p10×pb ~0.042/0.048 near_empty park). Inventory `eval-inventory-bias-20260824ai`. Propose 24ay: adopt then park `event_flatten_p10_pb_rising`. GOOD rotated flatten×p10×eps. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
