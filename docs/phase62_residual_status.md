...
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v124-24da-plus80` (`9aa3f555-8ce4-447f-9dd2-4807f226928d`). Baskets `eval-cf-dp-both-sleeves-20260824cz` not_a_pass (usable members). Durability `eval-durability-summary-20260824t` not_a_pass. Usable `eval-usable-inventory-20260824da` n_usable 652 (was 589). near_empty park 60. Thin sleeve exclude 164. always_on park 7. 24da +80 2-AND occupancy (67 material / 10 thin / 3 empty). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`. Deleted 7 uncited `docs/proof/raw_throughput_*` artifacts.
