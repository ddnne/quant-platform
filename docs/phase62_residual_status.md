...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824ag-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824ag-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v57-24ag-adopt` (`42deb5be-1015-47af-a380-b0d248c7ed70`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 18. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824ag`. Inventory `eval-inventory-bias-20260824ag`. Propose 24ag: unique px×np (EPS-vs-NP slang rejected) both-track material not sleeve (event_fund at 5). GOOD stays pb×price. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
