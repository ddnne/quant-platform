...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824ce-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824ce-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v106-24ce-pb-invert-tight` (`0afaf214-029a-4cf6-934f-fcdf9ad6fa12`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 31. Thin sleeve exclude 32. Occupancy `eval-occupancy-audit-20260824ce` (pb×invert×tight ~0.0495/0.0559 mixed thin-exclude; np×steep×easing ~0.014/0.014 near_empty park). Inventory `eval-inventory-bias-20260824ai`. Propose 24ce: thin `event_pb_invert_tight`; park `event_np_steep_easing`. GOOD rotated pb×invert×price. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
