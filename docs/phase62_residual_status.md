...
**Options vol differential + windows (W93):** [`docs/proof/w0818c_w93_opt225_basevol_atm_diff_20260818.md`](proof/w0818c_w93_opt225_basevol_atm_diff_20260818.md) · residual close [`w0818c_w93_residual_close_20260818.md`](proof/w0818c_w93_residual_close_20260818.md) · recipe `scripts/run_w93_opt225_diff_windows.py` · logs [`.glm-logs/w0818c_w93_opt225_diff/`](../.glm-logs/w0818c_w93_opt225_diff/) · CF mode **`r2_panels`** · job **`w93-opt225-20260818T120810Z`** · min_dte=**6** · SoT **`derivatives_bars_daily_options_225`** · TOPIX RV **proxy only**  
...
## options_225 BaseVol↔ATM differential + multi-year windows residual close（Dataset COMPLETE 22 held · SoT derivatives_bars_daily_options_225 · series v1.1 min_dte=6 · mode r2_panels · job w93-opt225-20260818T120810Z · windows w2017_2019/w2020_2022/w2023_2025 · CF thicken DONE · 3 defaults frozen · TOPIX proxy only · GO deferred · human main NOT selected）· W93
...
**CF job:** job_id **`w93-opt225-20260818T120810Z`** · mode **`r2_panels`** · status **ok** · n_survivors **2** · R2 **`quant-structured/research/mass_eval/job=w93-opt225-20260818T120810Z/`** · thickened sidecars staged  
