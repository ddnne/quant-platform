...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bc-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bc-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v79-24bc-flatten-pb-eps` (`c3a08fbb-667b-4fcb-b27f-6711ae78eb39`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 21. Thin sleeve exclude 16. Occupancy `eval-occupancy-audit-20260824bc` (flatten×pb×eps ~0.078/0.078 thin exclude). Inventory `eval-inventory-bias-20260824ai`. Propose 24bc: adopt `event_flatten_pb_eps_down` occupancy-equal thin. GOOD rotated flatten×pb×sales. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
