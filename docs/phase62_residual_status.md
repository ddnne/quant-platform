...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824cu-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824s-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824cu-liq_large`, `eval-cf-dp-both-sleeves-20260824s-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v119-24ct-usable-plus36` (`6deea7d0-5942-40b7-8ba9-53c18dcbf3e2`). Baskets `eval-cf-dp-both-sleeves-20260824s` not_a_pass. Durability `eval-durability-summary-20260824t` not_a_pass. Usable inventory `eval-usable-inventory-20260824t-after` n_usable 54 (before 21). near_empty park 35. Thin sleeve exclude 40. Occupancy `eval-occupancy-audit-20260824cu`. Propose 24ct adopt `event_eps_invert_px` plus 36 occupancy-correct 2-AND templates. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
