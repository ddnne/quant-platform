...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-adopt1g-20260824g`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-adopt1g-20260824g`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v37-propose-rise-contra` (`9ca761fe-9ddc-4aa1-b67d-bebb5852151c`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 13. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824g`. Inventory `eval-inventory-bias-20260824g`. Propose 24i: flatten×price_down + appetite-for-risk reject; clone eps×np; 0-adopt. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
