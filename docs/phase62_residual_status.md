...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824br-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824br-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v93-24br-p10-pb-px` (`b23c07d4-58cc-4b67-94e1-99ac2e03ba6c`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 25. Thin sleeve exclude 24. Occupancy `eval-occupancy-audit-20260824br` (p10×pb×px ~0.041/0.041 near_empty park). Inventory `eval-inventory-bias-20260824ai`. Propose 24br: adopt then park `event_p10_pb_px_down`. GOOD rotated p10×eps×sales. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
