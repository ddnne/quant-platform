...
**Live verified:** 2026-08-14 (JST) / ~2026-08-14T00:24Z UTC (remote D1; COMPLETE segs **942**; raw_n **9674**; G6 w0713_t6_deriv_edinet **+60**; FRESH age=0; empty COMPLETE **0**; Phase7 **OFF**)  
**Repo tip:** `ed7f8ab313d4ab38b9762700fede653fbee4f55f` — COMPLETE **942** / G6 **+60** (2025×5 DS) / empty COMPLETE **0** / Phase7 **OFF**
...
| Segment COMPLETE total | **942** (remote; prior **882** + **G6 w0713_t6_deriv_edinet +60**; **no** empty COMPLETE) |
...
| A3 sealed (partial datasets) | prior + G1/G2/G4 + **G6 t6_deriv_edinet +60** (futures/options_225/edinet×3 **2025-01…12**) → COMPLETE **942** |
| Remote `raw_retention_manifests` | **9674** total (G6 acq + peers; worker pass ≠ COMPLETE) |
| Track A + P0 execute | **w0713 multi-track** + **G1/G2/G4 close DONE** + **G6 t6_deriv_edinet +60 DONE**; peers not killed; **Worker pass ≠ COMPLETE** |
| master | `scd2_event_sourcing` / D1 hot |
| projection | **FRESH** — `projgen-08c14f21afd9498591f7992770dfc6e1` age=0 (G6 reeval freshness; segs untouched by reclock) |
