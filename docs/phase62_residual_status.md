...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824cz-newa-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824cz-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824cz-newa-liq_large`, `eval-cf-dp-both-sleeves-20260824cz-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v123-24cz-usable-basket` (`d13e699d-9854-479d-83d0-090069a9ca3e`). Baskets `eval-cf-dp-both-sleeves-20260824cz` not_a_pass (usable members). Durability `eval-durability-summary-20260824t` not_a_pass. Usable `eval-usable-inventory-20260824cz-after` n_usable 589 (was 549). near_empty park 57. Thin sleeve exclude 154. always_on park 7. New +40 material 2-AND (event 23 / surprise_xs 17). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`. Deleted 7 uncited `docs/proof/raw_throughput_*` artifacts.
