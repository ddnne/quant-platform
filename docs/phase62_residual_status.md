...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bj-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bj-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v85-24bj-flatten-eps-px` (`76709509-a1b9-4233-8a11-66b9233ad791`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 21. Thin sleeve exclude 20. Occupancy `eval-occupancy-audit-20260824bj` (flatten×eps×px ~0.156/0.177 material, below flatten_eps ~0.28, no sleeve swap). Inventory `eval-inventory-bias-20260824ai`. Propose 24bj: adopt `event_flatten_eps_px_down` occupancy-equal material. GOOD rotated flatten×np×sales. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
