...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bg-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bg-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v82-24bg-flatten-pb-px` (`95de537d-1635-4a48-a2d9-1c4907173ba3`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 21. Thin sleeve exclude 20. Occupancy `eval-occupancy-audit-20260824bg` (flatten×pb×px ~0.051/0.058 thin exclude). Inventory `eval-inventory-bias-20260824ai`. Propose 24bg: adopt `event_flatten_pb_px_down` occupancy-equal thin. GOOD rotated flatten×eps×np. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
