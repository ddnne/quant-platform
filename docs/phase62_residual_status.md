...
## OTC tip + failure-constrained hyps + frozen defaults quality residual close（Dataset COMPLETE 22 held · OTC segs 4501 tip · DEFER 4 · hyps grok-4.6 8/8/5 · llm-hyp v1.1 · CF defaults w96-defaults-20260818T141855Z r2_panels · 3 defaults frozen · 2 KEEP/PROMOTE contradictions recorded only · BaseVol canonical · ATM compare-only · spread off-mainline · GO deferred · human main NOT selected）· W96
...
**Defaults CF:** **`w96-defaults-20260818T141855Z`** · mode **`r2_panels`** · status **ok** · pins **frozen** · contradictions **2 recorded only**  
