...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824cb-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824cb-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v103-24cb-pb-sales-invert` (`9b62cab5-598e-49af-b103-6e9651bd188b`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 28. Thin sleeve exclude 31. Occupancy `eval-occupancy-audit-20260824cb` (pb×sales×invert ~0.078/0.085 thin exclude). Inventory `eval-inventory-bias-20260824ai`. Propose 24cb: adopt `event_pb_sales_invert` occupancy-equal thin. GOOD rotated pb×sales×tight. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
