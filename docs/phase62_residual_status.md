...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824cj-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824cj-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v110-24cj-eps-np-sales` (`cbd70b52-2dfd-4d27-a306-c770a52c6b81`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 33. Thin sleeve exclude 35. Occupancy `eval-occupancy-audit-20260824cj` (eps×np×sales ~0.120/0.126 mixed thin-exclude; not thicker than flatten_eps ~0.28). Inventory `eval-inventory-bias-20260824ai`. Propose 24cj: thin `event_eps_np_sales_down`. 24ci thin `event_eps_np_px_down`. 24ch park `event_pb_tight_px_down`. 24cg thin `event_pb_invert_px_down` / park `event_np_steep`. GOOD rotated eps×np×invert. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
