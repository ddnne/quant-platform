...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-adopt1e-20260824e`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-adopt1e-20260824e`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v33-propose-review-sot` (`83ea81ec-2e15-467f-87a2-1bcfbe5213bf`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 13. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824e`. Inventory `eval-inventory-bias-20260824e`. Propose 24e polarity SoT; Worker dropped slang slots; adopt tight_funding×price_down band; flatten+eps_down sleeve member. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters`.
