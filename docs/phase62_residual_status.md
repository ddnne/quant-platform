...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824dh-b0-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824df-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824dh-b0-liq_large`, `eval-cf-dp-both-sleeves-20260824df-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v131-24dh-plus81` (`26a942b2-8b08-4944-b3ee-5e837fe39e5e`). Baskets `eval-cf-dp-both-sleeves-20260824df` not_a_pass (usable members; 24dh lo max 0.278 < flow 4th 0.467, no reblend). Durability `eval-usable-read-20260824df` not_a_pass. Usable `eval-usable-inventory-20260824dh` n_usable 1342 (was 1290). near_empty park 63. Thin sleeve exclude 213. always_on park 7. 24dh +80 surprise_xs 3-AND + 1 event propose-adopt (52 material / 29 thin / 0 empty; non-event 80/81). Deleted 16 uncited `docs/proof` collect/ops logs this pack (8 in 24dg + 8 in 24dh). Propose `eval-cf-propose-20260824dg` n_adoptable 1 `event_pxd_liq_mup` (auto_inject false). Propose `eval-cf-propose-20260824dh` llm_failed 0-adopt (not soup). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
