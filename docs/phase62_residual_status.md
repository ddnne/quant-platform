...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824ck-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824ck-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v111-24ck-flatten-repo3m-np` (`53f39fae-95de-4209-9116-04e75f53d077`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 33. Thin sleeve exclude 36. Occupancy `eval-occupancy-audit-20260824ck` (flatten×repo3m×np ~0.057/0.057 thin-exclude). Inventory `eval-inventory-bias-20260824ai`. Propose 24ck: thin `event_flatten_repo3m_np_neg`. 24cj mixed thin `event_eps_np_sales_down` (~0.120/0.126, not > flatten_eps). GOOD remains eps×np×invert. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
