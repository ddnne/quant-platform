...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bd-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bd-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v80-24bd-flatten-pb-sales` (`0c36898f-23a8-4fa2-a6af-6f733c7c3215`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 21. Thin sleeve exclude 18. Occupancy `eval-occupancy-audit-20260824bd` (flatten×pb×sales ~0.054/0.061 thin; flatten×np×px ~0.064/0.064 thin). Inventory `eval-inventory-bias-20260824ai`. Propose 24bd: adopt `event_flatten_pb_sales_down` and `event_flatten_np_px_down` occupancy-equal thin. GOOD rotated flatten×pb×tight. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
