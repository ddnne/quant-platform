...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bp-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bp-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v91-24bp-p10-pb-sales` (`a785420a-9549-4ff5-96b3-f167816b268a`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 24. Thin sleeve exclude 23. Occupancy `eval-occupancy-audit-20260824bp` (p10×pb×sales ~0.023/0.023 near_empty park). Inventory `eval-inventory-bias-20260824ai`. Propose 24bp: adopt then park `event_p10_pb_sales_down`. GOOD rotated p10×pb×invert. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
