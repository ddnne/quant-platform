...
**Repo tip:** *(set to push SHA after this residual commit)* — COMPLETE **494** / raw 3535 / bars `2008-05-01` / breakdown `2015-04-01` / Phase7 **OFF** / margin C8 receipt lag **1d≤7** / `cf_premium_backfill` **not** launched
