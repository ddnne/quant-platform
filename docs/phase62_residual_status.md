...
**Live verified:** 2026-08-18 · **W92** options_225 BaseVol/ATM IV/spread (canonical Nikkei vol SoT) + CF real mass-eval · factory **v2.4** · class-signals **v9** · cf-mass-eval **v3** · CF job **`w92-opt225-20260817T231812Z`** (prior ok **`…T231531Z`**) · mode **`r2_panels`** (NOT synthetic-as-final) · n_logics **14** · n_periods **6** · CF survivors **2** · stage **6/6 ok** · R2 `research/mass_eval/job=w92-opt225-20260817T231812Z/` · panels with `opt225_regime` · dataset SoT **`derivatives_bars_daily_options_225`** (COMPLETE; 2452 daily BaseVol/ATM days) · spread convention **`atm_iv − base_vol`** · wide local **real_mirrors** **33** eval · survivors **25** · opt225 local survivors **basevol_abs · basevol_term_ratio · atm_iv_abs** · TOPIX/NK225F RV **proxy only** · options_225 **SoT** · W91 `nky_vol_*` **proxy/compare only** · **3 defaults frozen** · near-groups **parallel** · human main **NOT selected** · **GO deferred** · Mass/READY/Phase7/ops GO **NO-GO/未宣言/OFF/未宣言** · continuous paper **UNARMED** · COMPLETE **22** held · DEFER **4** · **no invent** · **no Mass/READY ON** · **no operational GO** · **no live** · **no simple_daily_sign mass** · **no hold/mom/frac grid** · **no synthetic-as-final** · proofs [`w0818b_w92_options_basevol_atm_20260818.md`](proof/w0818b_w92_options_basevol_atm_20260818.md) · [`w0818b_w92_residual_close_20260818.md`](proof/w0818b_w92_residual_close_20260818.md)  
**Repo tip:** `d8a6f41d1568ae39e25ee2fb48ffd1eaf5a00dea` — W92 residual tip pin to latest post-pin HEAD · COMPLETE **22** / DEFER **4** / Mass/READY/ops GO **NO-GO/未宣言/未宣言** · continuous paper **UNARMED** · 3 defaults **frozen**

## Research entry (W74 · … · W90 · real CF + Nikkei vol proxy W91 · options_225 BaseVol/ATM SoT W92)
...
**Stats bar:** `research-stats-metrics/v1` · class-signals **v9** · W81 stats floors held · W82 PIT held · W84 paper align · W85 multi-window · W86 sign+repo+compare · W87 mass factory · W88 logic-diversity · W89 rate+multifactor · W90 LLM+CF · W91 real CF + nky vol **proxy** · **W92 options_225 BaseVol/ATM SoT** (`mass-strategy-factory/v2.4`)  
**Options vol SoT + real CF (W92):** [`docs/proof/w0818b_w92_options_basevol_atm_20260818.md`](proof/w0818b_w92_options_basevol_atm_20260818.md) · residual close [`w0818b_w92_residual_close_20260818.md`](proof/w0818b_w92_residual_close_20260818.md) · `mass-strategy-factory/v2.4` · seed **870818** · recipe `scripts/run_w92_options_vol_cf_mass_eval.py` · logs [`.glm-logs/w0818b_w92_options_vol/`](../.glm-logs/w0818b_w92_options_vol/) · CF mode **`r2_panels`** · job **`w92-opt225-20260817T231812Z`** (prior ok **`…T231531Z`**) · SoT **`derivatives_bars_daily_options_225`** · spread **`atm_iv − base_vol`** · TOPIX RV **proxy only**  
...
**GO final gates:** [`docs/proof/w0816u_w86_go_gates_20260817.md`](proof/w0816u_w86_go_gates_20260817.md) · GO = **pre-live-order final gate** · **repo + compare table required before GO consideration** · operational GO **未宣言** · **W92 GO judgment deferred**  
**Status:** research entry **linked** under COMPLETE **22** · Mass/READY/Phase7/operational GO **NO-GO/未宣言/OFF/未宣言** · factory = **logic diversification** + **real CF multi-year mass-eval** + **options_225 vol regime (canonical)** + **index vol proxy** (not grid mass · not Mass ON) · **3 default production research_candidates frozen** (xs hold=10 mom=5 · xs hold=10 mom=3 · fund hold=10 mom=10; **not retuned this wave**; **not** Mass/READY) · factory survivors **≠** production research_candidate · StrategySpec **v3** · continuous paper **UNARMED**
