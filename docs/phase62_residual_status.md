...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bt-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bt-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v95-24bt-p10-eps-invert` (`9b6fcf03-9780-40fc-8f86-4129e711d6dd`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 25. Thin sleeve exclude 26. Occupancy `eval-occupancy-audit-20260824bt` (p10×eps×invert ~0.056/0.066 thin exclude). Inventory `eval-inventory-bias-20260824ai`. Propose 24bt: adopt `event_p10_eps_invert` occupancy-equal thin. GOOD rotated p10×sales×invert. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
