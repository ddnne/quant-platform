...
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v31-propose-parse`. Baskets reblend `eval-cf-dp-both-sleeves-20260823n` not_a_pass; durability `eval-durability-summary-20260823o`. Parked-empty combos are sparse (nkyvol+steep, cheap_iv+steep, plus32vf 3-sets). near_empty park 6. Inventory `eval-inventory-bias-20260823p`. Propose 23p 70B adopt 1 (mid occ) / clone 0 / polarity+sparse 2. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py`.
