...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824dj-b0-mid_n_explore`, `eval-cf-dp-basket-alts-20260824dj-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824dj-b0-liq_large`, `eval-cf-dp-basket-alts-20260824dj-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v133-24dj-plus64` (`1bbbc059-3bcb-40d7-999d-d6f22d2545b6`). Baskets keep `eval-cf-dp-both-sleeves-20260824df` (`eval-basket-decision-20260824dj` 3 alts on mid/liq 72/72, keep: nested parent and 1-AND soup rejected). Durability `eval-usable-read-20260824dj` v2 not_a_pass. Usable `eval-usable-inventory-20260824dj` n_usable 1454 (was 1390). near_empty park 63. Thin sleeve exclude 213. always_on park 7. 24dj +64 surprise_xs 3-AND (64 material / 0 thin / 0 empty; non-event 100%). Deleted `run_paper_once.py`, `tests/test_phase7_pipeline_budget.py`, `tests/test_phase7_knowledge.py`, plus 12 uncited proof logs. Propose `eval-cf-propose-20260824dj` llm_failed 0-adopt (not soup). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
