...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-adopt1b-20260824b`, `eval-cf-dp-mid80-adopt1a-20260824a`, `eval-cf-dp-both-sleeves-20260823n-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-adopt1b-20260824b`, `eval-cf-dp-liq100-adopt1a-20260824a`, `eval-cf-dp-both-sleeves-20260823n-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v32-propose-polar-sparse` (`1365b65b-ad4f-4b65-bfad-3b44a50f50d3`). Baskets reblend `eval-cf-dp-both-sleeves-20260823n` not_a_pass; durability `eval-durability-summary-20260823o`. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 6. Occupancy `eval-occupancy-audit-20260824b` material-band. Inventory `eval-inventory-bias-20260824b`. Propose 24a adopt `event_eps_down_pb_rising` (PB = above PIT median); 24b adopt `event_eps_down_np_negative` (YAML occupancy, not extra tight-funding). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py`.
