...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824dd-b0-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824dd-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824dd-b0-liq_large`, `eval-cf-dp-both-sleeves-20260824dd-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v127-24dd-plus160` (`5f13a14e-6380-473e-854d-8bee185130ec`). Baskets `eval-cf-dp-both-sleeves-20260824dd` not_a_pass (usable members). Durability `eval-durability-summary-20260824t` not_a_pass. Usable `eval-usable-inventory-20260824dd` n_usable 1029 (was 869). near_empty park 63. Thin sleeve exclude 184. always_on park 7. 24dd +160 occupancy-correct 2/3-ANDs (160 material / 0 thin; new-material event share 55.6%). Propose `eval-cf-propose-20260824dd` n_adoptable 1 (`afterclose+price_down+curve_flatten`) auto_inject false. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
