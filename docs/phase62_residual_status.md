...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-plus32vf-20260823h`, `eval-cf-dp-mid80-adopt2i-20260823i`, `eval-cf-dp-mid80-adopt2j-20260823j`, `eval-cf-dp-both-sleeves-20260823e-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-plus32vf-20260823h`, `eval-cf-dp-liq100-adopt2i-20260823i`, `eval-cf-dp-liq100-adopt2j-20260823j`, `eval-cf-dp-both-sleeves-20260823e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v31-propose-parse`. Durability `eval-durability-summary-20260823h` not_a_pass. Occupancy `eval-occupancy-audit-20260823i` (plus32vf 4 near_empty) and `eval-occupancy-audit-20260823k` (23i/23j adopts mid-band; sleeves no near_empty). unique22 park `eval-unique22-park-20260823i`. Inventory `eval-inventory-bias-20260823j`. Propose 23k 70B n_adoptable=1 then polarity-reject (`eq_ar_falling` vs high-equity title); nkyvol invert also rejected. unique22 5/17. factory LogicTemplate default fail-closed. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML.
