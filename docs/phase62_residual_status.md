...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-adopt2r-20260824r`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-adopt2r-20260824r`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v42-adopt2r` (`aebd3497-70ee-444d-8a9c-e60401cde716`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 14. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824r`. Inventory `eval-inventory-bias-20260824r`. Propose 24r: adopt flatten×easy×uncrowded and invert×pb band (not sleeve); flatten/invert contra; slang yield-curve/ROE extra-title. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
