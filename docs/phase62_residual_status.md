...
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v59-24ai-adopt` (`4564952e-b62f-44eb-a9bd-5cfe6ea5b655`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 18. Thin sleeve exclude includes 24ai pb×price. Occupancy `eval-occupancy-audit-20260824ai`. Inventory `eval-inventory-bias-20260824ai`. Propose 24ai: GOOD pb×price occupancy-correct adopt, both-track thin not sleeve (event_fund at 5). GOOD rotated to eps×sales. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
