...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bs-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bs-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v94-24bs-p10-eps-sales` (`f983738e-5da6-4761-a862-9a3825ae28f5`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 25. Thin sleeve exclude 25. Occupancy `eval-occupancy-audit-20260824bs` (p10×eps×sales ~0.065/0.065 thin exclude). Inventory `eval-inventory-bias-20260824ai`. Propose 24bs: adopt `event_p10_eps_sales_down` occupancy-equal thin. GOOD rotated p10×eps×invert. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
