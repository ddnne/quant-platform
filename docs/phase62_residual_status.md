...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bz-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bz-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v101-24bz-pb-eps-tight` (`ea7155fd-4c2b-470c-bd60-fb934ea8b230`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 28. Thin sleeve exclude 29. Occupancy `eval-occupancy-audit-20260824bz` (pb×eps×tight ~0.043/0.043 near_empty park). Inventory `eval-inventory-bias-20260824ai`. Propose 24bz: adopt then park `event_pb_eps_tight`. GOOD rotated pb×eps×price. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
