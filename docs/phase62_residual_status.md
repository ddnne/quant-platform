...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-adopt2t-20260824t`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-adopt2t-20260824t`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v44-adopt2t` (`ea06bac1-79bb-41ef-8005-1658205b6a59`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 14. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824t`. Inventory `eval-inventory-bias-20260824t`. Propose 24t: adopt flatten×sales band and flatten×tight×px band (not sleeve); GOOD rotated to flatten×tight. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
