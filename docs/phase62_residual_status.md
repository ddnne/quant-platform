...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-adopt1z-20260823z`, `eval-cf-dp-mid80-adopt1v-20260823v`, `eval-cf-dp-both-sleeves-20260823n-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-adopt1z-20260823z`, `eval-cf-dp-liq100-adopt1v-20260823v`, `eval-cf-dp-both-sleeves-20260823n-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v32-propose-polar-sparse` (`98a3a1d5-5731-41c5-af33-8d01c820a6b3`). Baskets reblend `eval-cf-dp-both-sleeves-20260823n` not_a_pass; durability `eval-durability-summary-20260823o`. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 6. Occupancy `eval-occupancy-audit-20260823z` material-band. Inventory `eval-inventory-bias-20260823z`. Propose 23y clone/label 0; 23z adopt 1 (`event_overnight_p10_eps_down`; YAML occupancy not “funding at 10%”). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py`.
