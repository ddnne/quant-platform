...
**Live verified:** 2026-08-18 · **W92** options_225 BaseVol/ATM IV/spread (canonical Nikkei vol SoT) + CF real mass-eval · factory **v2.4** · class-signals **v9** · cf-mass-eval **v3** · CF job **`w92-opt225-20260817T231531Z`** · mode **`r2_panels`** (NOT synthetic-as-final) · n_logics **14** · n_periods **6** · CF survivors **2** · stage **6/6 ok** · R2 `research/mass_eval/job=w92-opt225-20260817T231531Z/` · panels with `opt225_regime` · dataset SoT **`derivatives_bars_daily_options_225`** (COMPLETE; 2452 daily BaseVol/ATM days) · spread convention **`atm_iv − base_vol`** · wide local **real_mirrors** **33** eval · survivors **25** · opt225 local survivors **basevol_abs · basevol_term_ratio · atm_iv_abs** · W91 `nky_vol_*` **proxy/compare only** · **3 defaults frozen** · near-groups **parallel** · human main **NOT selected** · **GO deferred** · Mass/READY/Phase7/ops GO **NO-GO/未宣言/OFF/未宣言** · continuous paper **UNARMED** · COMPLETE **22** held · DEFER **4** · **no invent** · **no Mass/READY ON** · **no operational GO** · **no live** · **no simple_daily_sign mass** · **no hold/mom/frac grid** · **no synthetic-as-final** · proofs [`w0818b_w92_options_basevol_atm_20260818.md`](proof/w0818b_w92_options_basevol_atm_20260818.md) · [`w0818b_w92_residual_close_20260818.md`](proof/w0818b_w92_residual_close_20260818.md)  
**Repo tip:** `1bbb8a67b41b2b0fee793f264b27ae77e0c60ff3` — W92 residual tip pin to latest post-pin HEAD · COMPLETE **22** / DEFER **4** / Mass/READY/ops GO **NO-GO/未宣言/未宣言** · continuous paper **UNARMED** · 3 defaults **frozen**
...
**Options vol SoT + real CF (W92):** [`docs/proof/w0818b_w92_options_basevol_atm_20260818.md`](proof/w0818b_w92_options_basevol_atm_20260818.md) · residual close [`w0818b_w92_residual_close_20260818.md`](proof/w0818b_w92_residual_close_20260818.md) · `mass-strategy-factory/v2.4` · seed **870818** · recipe `scripts/run_w92_options_vol_cf_mass_eval.py` · logs [`.glm-logs/w0818b_w92_options_vol/`](../.glm-logs/w0818b_w92_options_vol/) · CF mode **`r2_panels`** · job **`w92-opt225-20260817T231531Z`** · SoT **`derivatives_bars_daily_options_225`** · spread **`atm_iv − base_vol`**  
...
## options_225 BaseVol/ATM/spread residual close（Dataset COMPLETE 22 held · SoT derivatives_bars_daily_options_225 · mode r2_panels · job w92-opt225-20260817T231531Z · 8 opt225 logics · wide real 33 eval · survivors 25 · 3 defaults frozen · nky_vol proxy/compare · GO deferred · human main NOT selected）· W92
