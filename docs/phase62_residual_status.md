...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bl-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bl-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v87-24bl-flatten-np-tight` (`df2f22b5-3bbf-4625-b351-f3af45c8cac5`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 22. Thin sleeve exclude 21. Occupancy `eval-occupancy-audit-20260824bl` (flatten×np×tight ~0.046/0.046 near_empty park). Inventory `eval-inventory-bias-20260824ai`. Propose 24bl: adopt then park `event_flatten_np_tight`. GOOD rotated flatten×sales×tight. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
