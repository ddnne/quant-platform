...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bi-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bi-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v84-24bi-flatten-eps-sales` (`1c4109fb-d775-4ee0-8d1e-5648741f2842`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 21. Thin sleeve exclude 20. Occupancy `eval-occupancy-audit-20260824bi` (flatten×eps×sales ~0.188/0.188 material, below flatten_eps ~0.28, no sleeve swap). Inventory `eval-inventory-bias-20260824ai`. Propose 24bi: adopt `event_flatten_eps_sales_down` occupancy-equal material. GOOD rotated flatten×eps×price. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
