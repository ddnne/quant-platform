...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824ac-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824ac-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v53-24ac-adopt` (`ded0e82b-2649-4dd2-bcd1-9e9a3803da6f`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 16. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824ac`. Inventory `eval-inventory-bias-20260824ac`. Propose 24ac: GOOD p10×invert occupancy-correct adopt, both-track material not sleeve (event_fund at 5). GOOD rotated to pb_rising×np. invert occupancy-label requires repo curve. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
