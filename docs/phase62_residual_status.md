...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bx-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bx-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v99-24bx-pb-eps-sales` (`6af89818-7144-4e17-b5df-3dd398af5580`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 27. Thin sleeve exclude 28. Occupancy `eval-occupancy-audit-20260824bx` (pb×eps×sales ~0.086/0.086 thin exclude). Inventory `eval-inventory-bias-20260824ai`. Propose 24bx: adopt `event_pb_eps_sales_down` occupancy-equal thin. GOOD rotated pb×eps×invert. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
