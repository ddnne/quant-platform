...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824aa-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824aa-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v51-24aa-adopt` (`80445897-8413-45c4-b90c-4b6b92cc4682`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park includes 24aa p10×sales×eps_up. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824aa`. Inventory `eval-inventory-bias-20260824aa`. Propose 24aa: clone then retry 1-adopt p10×sales×eps_up both-track near_empty parked. rising-EPS occupancy-label. GOOD stays p10×np. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
