...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-plus41-20260823r`, `eval-cf-dp-both-sleeves-20260823q-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-plus41-20260823r`, `eval-cf-dp-both-sleeves-20260823q-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v32-propose-polar-sparse` (`54de4a85-a34b-48e0-a0dd-6e3edbc4ef6d`). Baskets `eval-cf-dp-both-sleeves-20260823q` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 11. Occupancy `eval-occupancy-audit-20260823r` material-band +40. Family mix `eval-family-mix-20260823r`. Inventory `eval-inventory-bias-20260823r`. Propose 23r clone 1 / occupancy-empty parked 1; hand-template +40 band. unique22 5/17. GO deferred. Deleted: eval_harness.py, paper_candidate_adapter.py, test_eval_harness.py. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py`.
