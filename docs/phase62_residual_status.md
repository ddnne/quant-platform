...
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v31-propose-parse`. Durability `eval-durability-summary-20260823h` not_a_pass. Occupancy audit `eval-occupancy-audit-20260823i` (4 near_empty in plus32vf; not materials). unique22 park map `eval-unique22-park-20260823i`. Inventory `eval-inventory-bias-20260823j`. Propose 23i n_adoptable=2; 23j n_adoptable=3 with 1 polarity reject (`nky_vol_high_skip` title). unique22 5/17. cheap_pb cap on. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / factory OFF / unique22 park YAML.
