...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824ba-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824ba-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v77-24ba-flatten-p10-sales` (`4b5b3956-e426-46e7-bbb0-c36ae7c9824c`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 20. Thin sleeve exclude 15. Occupancy `eval-occupancy-audit-20260824ba` (flatten×p10×sales ~0.025/0.025 near_empty park). Inventory `eval-inventory-bias-20260824ai`. Propose 24ba: adopt then park `event_flatten_p10_sales_down`. GOOD rotated flatten×p10×price. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
