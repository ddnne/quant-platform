...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824by-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824by-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v100-24by-pb-eps-invert` (`bb495c1c-f6aa-4ede-a051-b436e1712492`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 27. Thin sleeve exclude 29. Occupancy `eval-occupancy-audit-20260824by` (pb×eps×invert ~0.101/0.107 thin exclude). Inventory `eval-inventory-bias-20260824ai`. Propose 24by: adopt `event_pb_eps_invert` occupancy-equal thin. GOOD rotated pb×eps×tight. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
