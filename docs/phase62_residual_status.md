...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bb-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bb-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v78-24bb-flatten-p10-px` (`5150b27d-a5c7-415c-b488-0b8934e86ba1`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 21. Thin sleeve exclude 15. Occupancy `eval-occupancy-audit-20260824bb` (flatten×p10×px ~0.048/0.049 near_empty park). Inventory `eval-inventory-bias-20260824ai`. Propose 24bb: adopt then park `event_flatten_p10_px_down`. GOOD rotated flatten×pb×eps. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
