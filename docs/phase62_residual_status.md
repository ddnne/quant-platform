...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824dn-b0-mid_n_explore`, `eval-cf-dp-basket-alts-20260824dn-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824dn-b0-liq_large`, `eval-cf-dp-basket-alts-20260824dn-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v137-24dn-plus64` (`a6bb7490-a33e-486e-afde-a9eb3e282050`). Baskets keep `eval-cf-dp-both-sleeves-20260824df` (`eval-basket-decision-20260824dn` event 3-AND + CS lo<0.70 alts mid/liq 72/72, keep: min lo below flow 4th 0.426; CS is not fund x event). Cost/risk `eval-usable-cost-risk-20260824dn` not_a_pass. Usable `eval-usable-inventory-20260824dn` n_usable 1702 (was 1638). near_empty park 63. Thin sleeve exclude 213. always_on park 7. 24dn +64 event 3-AND (64 material / 0 thin; surprise_xs share of new 0%; flow 30 / vol 22 / rate 12). Deleted 12 uncited w0814d/e proofs. Propose `eval-cf-propose-20260824dn` n_adoptable 1 not written (parent lo 0.12 thin, n_pri=1). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
