...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bf-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bf-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v81-24bf-flatten-pb-tight` (`82669b38-126e-4aaf-bf1a-484205968e34`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 21. Thin sleeve exclude 19. Occupancy `eval-occupancy-audit-20260824bf` (flatten×pb×tight ~0.070/0.084 thin exclude). Inventory `eval-inventory-bias-20260824ai`. Propose 24bf: adopt `event_flatten_pb_tight` occupancy-equal thin. GOOD rotated flatten×pb×price. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
