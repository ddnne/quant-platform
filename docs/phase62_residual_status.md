...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-adopt2v-20260824v`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-adopt2v-20260824v`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v46-adopt2v` (`7d25448c-96f1-4fad-a57a-bef79103fefd`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 14. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824v`. Inventory `eval-inventory-bias-20260824v`. Propose 24v: adopt eps_down×px band and p10×sales thin-exclude (not sleeve); easing/selling-opportunity extra-title. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
