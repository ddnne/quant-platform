...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bw-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bw-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v98-24bw-p10-invert-px` (`75df2e13-0e4a-493a-ad41-bbb17e7107fe`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 27. Thin sleeve exclude 27. Occupancy `eval-occupancy-audit-20260824bw` (p10×invert×px ~0.070/0.077 thin exclude). Inventory `eval-inventory-bias-20260824ai`. Propose 24bw: adopt `event_p10_invert_px_down` occupancy-equal thin. GOOD rotated pb×eps×sales. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
