...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-adopt1c-20260824c`, `eval-cf-dp-both-sleeves-20260823q-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-adopt1c-20260824c`, `eval-cf-dp-both-sleeves-20260823q-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v32-propose-polar-sparse` (`49f216ed-a3e2-48b8-99bc-af7ca92605d4`). Baskets `eval-cf-dp-both-sleeves-20260823q` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 12. Thin sleeve exclude (`event_p10_pb_rising` and recorded ~0.12). Occupancy `eval-occupancy-audit-20260824c`. Inventory `eval-inventory-bias-20260824c`. Propose 24c clone 1 / flatten+roe+np empty parked. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py`.
