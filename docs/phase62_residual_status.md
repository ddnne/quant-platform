...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824co-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824co-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v115-24co-eps-steep` (`7bd47f2b-7e58-4391-85d0-fecc75eeb4a2`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 33. Thin sleeve exclude 38. Occupancy `eval-occupancy-audit-20260824co` (eps×steep ~0.083/0.084 thin-exclude; 24cn 3-AND 0.061 nested). Inventory `eval-inventory-bias-20260824ai`. Propose 24cl/24cm 0-adopt (flatten steep contra; BAD-signal echo). 24cn thin `event_eps_px_steep`. 24co thin `event_eps_steep`. GOOD remains eps×np×invert. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
