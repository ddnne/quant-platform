...
**Live verified:** 2026-08-18 · **W96** OTC tip FULL_OK **4499→4501 (+2)** · failure-constrained hyps (xAI grok-4.6 **8/8/5**) · frozen **3-default quality** (pins unchanged · mild KEEP/PROMOTE window notes **recorded only**) · CF defaults **`w96-defaults-20260818T142144Z`** mode **`r2_panels`** · llm-hyp **v1.1** · factory **v2.5** · cf-mass-eval **v6** · **BaseVol = canonical** · ATM **compare-only** · spread **off-mainline** · W95 underneath held (shape WEAK · rate/flow weak_thesis · fund2017 demoted · low-var t-gate) · **3 defaults frozen** · near-groups **parallel** · human main **NOT selected** · **GO deferred** · Mass/READY/Phase7/ops GO **NO-GO/未宣言/OFF/未宣言** · continuous paper **UNARMED** · COMPLETE **22** held · DEFER **4** · OTC dataset **PARTIAL** · tip segs **4501** · platform segs **7890** · **no invent** · **no densify** · **no Mass/READY ON** · **no operational GO** · **no live** · **no simple_daily_sign mass** · **no hold/mom/frac grid** · **no synthetic-as-final** · proofs [`w0818f_w96_otc_partial_progress_20260818.md`](proof/w0818f_w96_otc_partial_progress_20260818.md) · [`w0818f_w96_hyps_defaults_20260818.md`](proof/w0818f_w96_hyps_defaults_20260818.md) · [`w0818f_w96_residual_close_20260818.md`](proof/w0818f_w96_residual_close_20260818.md)  
**Repo tip:** `2a0a3d40e042950ad3bb1ab5841313bbcfc31ede` — W96 residual tip pin to latest post-pin HEAD · COMPLETE **22** / DEFER **4** / OTC tip **4501** · Mass/READY/ops GO **NO-GO/未宣言/未宣言** · continuous paper **UNARMED** · 3 defaults **frozen** · projection **FRESH**

## Research entry (W74 · … · W90 · real CF + Nikkei vol proxy W91 · options_225 BaseVol/ATM SoT W92 · BaseVol↔ATM differential W93 · skew/CM-term/ΔBaseVol + thick W94 · shape deep-dive + rate/flow/fund decomp W95 · OTC tip + failure-constrained hyps + defaults quality W96)
