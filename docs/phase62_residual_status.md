...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824ae-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824ae-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v55-24ae-adopt` (`588a0142-6a4d-4fea-b070-63fd21286232`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park includes 24ae pb×np. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824ae`. Inventory `eval-inventory-bias-20260824ae`. Propose 24ae: GOOD pb×np occupancy-correct adopt then both-track near_empty parked; GOOD rotated to pb×sales. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
