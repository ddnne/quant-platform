...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-adopt1x-20260824x`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-adopt1x-20260824x`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v49-title-meta` (`503b41a6-657d-48d4-b5f0-f0c00b1b5e0f`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 14. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824x`. Inventory `eval-inventory-bias-20260824x`. Propose 24y: 0-adopt clone p10×sales (no soup). TITLE_OCCUPANCY_META rejects occupancy-as-metric titles. GOOD stays p10×np. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
