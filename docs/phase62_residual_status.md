...
| Remote `raw_retention_manifests` | **live ~3535** total (D1 RO; bars mid-hole / premium continues; local research mirror raw still partial) |
| Track A + P0 execute | equities bars week/month/5d waves; topix history; margin latest+Jul re-exec. **Worker pass ≠ COMPLETE** |
| master | `scd2_event_sourcing` / D1 hot |
| projection | **FRESH** — `projgen-8811c3ea7cb746b58980a93eda7fada5` (`generated_at=2026-08-13T11:31:12.718889+00:00`, age_seconds=0; targeted `ops_reeval_freshness`; local `data/ops/projection_meta.json`) |
...
| `markets_margin_interest` | **PARTIAL** | **14** | **`2024-01-01`** | **`2026-08-12`** | — | receipt-plane C8 lag **1d≤7** PASS; cold detail C8 530d remnant not SoT; **not** COMPLETE |
...
| margin STALE → PARTIAL (freshness) | **DONE** (remote PARTIAL; `observed_end=2026-08-12`; receipt C8 lag 1d≤7; cold 530d detail remnant; not dataset COMPLETE) |
