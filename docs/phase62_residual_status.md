...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824cd-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824cd-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v105-24cd-pb-sales-px` (`cb2ea83a-75fd-428e-bc9a-834a46834398`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 30. Thin sleeve exclude 31. Occupancy `eval-occupancy-audit-20260824cd` (pb×sales×px ~0.040/0.047 near_empty park). Inventory `eval-inventory-bias-20260824ai`. Propose 24cd: adopt then park `event_pb_sales_px_down`. GOOD rotated pb×invert×tight. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
