...
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v38-occupancy-extra` (`d8939a63-69ca-4221-a6bf-1f1f31cb6875`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 13. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824g`. Inventory `eval-inventory-bias-20260824g`. Propose 24j: price-is-rising polarity and low-PB/market-crowded slang 0-adopt. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
