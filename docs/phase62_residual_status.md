...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824do-b0-mid_n_explore`, `eval-cf-dp-basket-alts-20260824do-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824do-b0-liq_large`, `eval-cf-dp-basket-alts-20260824do-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v138-24do-plus22` (`cce6b7e3-3d1c-497c-bc2e-2bf89ddc3c8a`). Baskets keep `eval-cf-dp-both-sleeves-20260824df` (`eval-basket-decision-20260824do` event 3-AND + CS curve alts mid/liq 72/72, keep: min lo below flow 4th 0.426; CS is not fund x event). Cost/risk `eval-usable-cost-risk-20260824do` not_a_pass. Usable `eval-usable-inventory-20260824do` n_usable 1724 (was 1702). near_empty park 63. Thin sleeve exclude 213. always_on park 7. 24do +22 event vol 3-AND (22 material / 0 thin; surprise_xs share of new 0%; rate parent lo>0.22 exhausted, flow-fill dropped). Deleted 12 uncited w0814e/f/g proofs. Propose `eval-cf-propose-20260824do` llm_failed 0-adopt (not soup). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
