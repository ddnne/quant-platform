...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bn-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bn-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v89-24bn-flatten-sales-px` (`4c9ad2b5-5a03-451d-a559-023ed39ff835`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 22. Thin sleeve exclude 23. Occupancy `eval-occupancy-audit-20260824bn` (flatten×sales×px ~0.092/0.104 thin exclude). Inventory `eval-inventory-bias-20260824ai`. Propose 24bn: adopt `event_flatten_sales_px_down` occupancy-equal thin. GOOD rotated p10×pb×eps. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
