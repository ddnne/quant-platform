...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824af-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824af-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v56-24af-adopt` (`c0a60a4b-2d83-4f5b-984b-ea2d954dd24f`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 18. Thin sleeve exclude includes 24af pb×sales. Occupancy `eval-occupancy-audit-20260824af`. Inventory `eval-inventory-bias-20260824af`. Propose 24af: GOOD pb×sales occupancy-correct adopt, both-track thin not sleeve (event_fund at 5). GOOD rotated to pb×price. flatten occupancy-label requires repo curve. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
