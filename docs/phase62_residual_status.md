...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824ad-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824ad-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v54-24ad-adopt` (`05787f6d-9243-4136-86c9-eca507b38668`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park includes 24ad tight×sales×np. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824ad`. Inventory `eval-inventory-bias-20260824ad`. Propose 24ad: unique 3-AND tight×sales×np both-track near_empty parked. GOOD stays pb_rising×np. falling-sales occupancy-label. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
