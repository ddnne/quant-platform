...
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v31-propose-parse`. Baskets reblend `eval-cf-dp-both-sleeves-20260823n` not_a_pass; durability `eval-durability-summary-20260823o`. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 6. Inventory `eval-inventory-bias-20260823r`. Propose 23s 70B clone 1 / polarity-reject 1 (`eq_ar_falling` vs rising equity); 0 adopt. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py`.
