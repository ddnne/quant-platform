...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824cy-left1-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824s-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824cy-left1-liq_large`, `eval-cf-dp-both-sleeves-20260824s-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v122-24cy-unclass-digest` (`f88655c6-0e03-4f97-833c-7c97558031d1`). Baskets `eval-cf-dp-both-sleeves-20260824s` not_a_pass. Durability `eval-durability-summary-20260824t` not_a_pass. Usable `eval-usable-inventory-20260824cy` n_usable 549 (was 241). near_empty park 57. Thin sleeve exclude 152. always_on park 7. Occupancy unclass digest (cx 320 + cy 134); remaining unclassified 0 of prior countable. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
