...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824de-b0-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824dd-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824de-b0-liq_large`, `eval-cf-dp-both-sleeves-20260824dd-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v128-24de-plus120` (`c2ba4525-9a5b-4491-8b9f-049ef5f435ee`). Baskets `eval-cf-dp-both-sleeves-20260824dd` not_a_pass (usable members). Durability `eval-durability-summary-20260824t` not_a_pass. Usable `eval-usable-inventory-20260824de` n_usable 1149 (was 1029). near_empty park 63. Thin sleeve exclude 184. always_on park 7. 24de +120 material-parent 3-ANDs (120 material / 0 thin; new-material event share 50%; includes propose-adopt `event_ac_flat_pxd`). Propose `eval-cf-propose-20260824de-retry` n_adoptable 1 (`afterclose+curve_flatten+repo_3m_down`) auto_inject false. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
