...
> **Live residual SoT.** Feature HEAD `0a8ced34` vs `origin/main` `b5c326a`. Live MCP: Projection **STALE**, READY **null**, B0 **UNKNOWN**, `applied_cursor` **null**. Mass **NO-GO**. Phase 7 **OFF**. Do not treat 22 COMPLETE as live V3.
