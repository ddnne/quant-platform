...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-adopt1t-20260823t`, `eval-cf-dp-mid80-adopt1v-20260823v`, `eval-cf-dp-both-sleeves-20260823n-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-adopt1t-20260823t`, `eval-cf-dp-liq100-adopt1v-20260823v`, `eval-cf-dp-both-sleeves-20260823n-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v31-propose-parse` (`2fb356b7-bf8c-4591-a962-b4e14987a375`). Baskets reblend `eval-cf-dp-both-sleeves-20260823n` not_a_pass; durability `eval-durability-summary-20260823o`. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 6. Occupancy `eval-occupancy-audit-20260823v` material-band. Inventory `eval-inventory-bias-20260823v`. Propose 23t adopt 1 (`event_repo3m_eqar_falling`); 23u occupancy-label 0; 23v adopt 1 (`event_ta_up_eqar_falling`); 23w polarity/sparse/label 0; 23x TA-as-technical-analysis occupancy-label 0. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py`.
