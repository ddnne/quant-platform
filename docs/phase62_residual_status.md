...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824dk-b0-mid_n_explore`, `eval-cf-dp-basket-alts-20260824dk-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824dk-b0-liq_large`, `eval-cf-dp-basket-alts-20260824dk-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v134-24dk-plus56` (`8f9a71ce-80df-4b87-a14c-cd144123015c`). Baskets keep `eval-cf-dp-both-sleeves-20260824df` (`eval-basket-decision-20260824dk` 3 funds 3-AND alts mid/liq 72/72, keep: min lo below flow 4th). Cost/risk `eval-usable-cost-risk-20260824dk` not_a_pass. Usable `eval-usable-inventory-20260824dk` n_usable 1510 (was 1454). near_empty park 63. Thin sleeve exclude 213. always_on park 7. 24dk +56 event 3-AND (56 material / 0 thin; surprise_xs share of new 0%; rate 40 / flow 12 / vol 4). Deleted `tests/test_phase7_gateway.py`, `tests/test_jquants_job_expansion_date.py`, plus 10 uncited proof logs. Propose `eval-cf-propose-20260824dk` llm_failed 0-adopt (not soup). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
