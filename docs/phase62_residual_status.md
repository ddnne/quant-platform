...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824cw-b1-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824s-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824cw-b1-liq_large`, `eval-cf-dp-both-sleeves-20260824s-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v121-24cw-unclass-160` (`02747b80-68d5-4f99-a3f2-65a248443971`). Baskets `eval-cf-dp-both-sleeves-20260824s` not_a_pass. Durability `eval-durability-summary-20260824t` not_a_pass. Usable `eval-usable-inventory-20260824cw` n_usable 241 (was 108). near_empty park 44. Thin sleeve exclude 90. always_on park 4. Occupancy unclass-160. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
