...
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v34-propose-allowed-sot` (`70bc011e-169f-49f6-a489-5350fe341b17`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 13. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824e`. Inventory `eval-inventory-bias-20260824e`. Propose 24e adopt tight×px band; 24f clone 0-adopt (easy_funding+ta_up). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
