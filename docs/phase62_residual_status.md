...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824dm-b0-mid_n_explore`, `eval-cf-dp-basket-alts-20260824dm-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824dm-b0-liq_large`, `eval-cf-dp-basket-alts-20260824dm-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v136-24dm-plus64` (`c378e6c2-1cd5-42b9-bd52-55edc86ff14c`). Baskets keep `eval-cf-dp-both-sleeves-20260824df` (`eval-basket-decision-20260824dm` 3 event 3-AND alts mid/liq 72/72, keep: min lo below flow 4th 0.426). Cost/risk `eval-usable-cost-risk-20260824dm` not_a_pass. Usable `eval-usable-inventory-20260824dm` n_usable 1638 (was 1574). near_empty park 63. Thin sleeve exclude 213. always_on park 7. 24dm +64 event 3-AND (64 material / 0 thin; surprise_xs share of new 0%; vol 22 / flow 22 / rate 20). Combo runtime lazy-cached. Deleted 12 uncited w0814b/c proofs. Propose `eval-cf-propose-20260824dm` llm_failed 0-adopt (not soup). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
