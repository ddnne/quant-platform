...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bo-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bo-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v90-24bo-p10-pb-eps` (`93fb7dcb-65ed-41c1-9a1e-b998c22639e6`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 23. Thin sleeve exclude 23. Occupancy `eval-occupancy-audit-20260824bo` (p10×pb×eps ~0.033/0.033 near_empty park). Inventory `eval-inventory-bias-20260824ai`. Propose 24bo: adopt then park `event_p10_pb_eps_down`. GOOD rotated p10×pb×sales. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
