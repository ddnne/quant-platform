...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824ca-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824ca-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v102-24ca-pb-eps-px` (`0277924f-d608-44fa-93a5-be3963610883`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 28. Thin sleeve exclude 30. Occupancy `eval-occupancy-audit-20260824ca` (pb×eps×px ~0.058/0.064 thin exclude). Inventory `eval-inventory-bias-20260824ai`. Propose 24ca: adopt `event_pb_eps_px_down` occupancy-equal thin. GOOD rotated pb×sales×invert. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
