...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-plus60-20260823q`, `eval-cf-dp-both-sleeves-20260823q-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-plus60-20260823q`, `eval-cf-dp-both-sleeves-20260823q-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v32-propose-polar-sparse` (`f0a8a594-7bf9-4c3e-a634-897d9a47de85`). Baskets reblend `eval-cf-dp-both-sleeves-20260823q` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 10. Occupancy `eval-occupancy-audit-20260823q` material-band +56. Family mix `eval-family-mix-20260823q`. Inventory `eval-inventory-bias-20260823q`. Deadcode HOLD `eval-deadcode-hold-20260823q`. Propose 23q clone 1 / extra-title 1; 0 adopt. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / jsda adapters / listed scripts.
