...
**Live verified:** 2026-08-18 · **W94** options_225 **skew / CM-term / ΔBaseVol** + multi-year windows (2017–2019 / 2020–2022 / 2023–2025 honest shards) + thick rate/flow/fund/mf · **BaseVol = canonical level** · ATM **compare-only** · spread **off-mainline** (non-informative) · series **v1.2** · factory **v2.5** · class-signals **v10** · cf-mass-eval **v5** · CF skew job **`w94-skew-20260818T130829Z`** · thick job **`w94-thick-20260818T125009Z`** · **mdh_fb=0** · mode **`r2_panels`** (NOT synthetic-as-final) · CF skew survivors **3** · thick aggregate survivors **8** · SoT **`derivatives_bars_daily_options_225`** · logics `opt225_skew_abs_level` · `opt225_cm_term_abs_level` · `opt225_basevol_delta_abs` · shape/change **≠** BaseVol abs level (esp. w2020_2022 level dies / shape survives; w2017_2019 sign divergence) · **do not claim smile/surface ≡ level** · TOPIX RV **proxy only** · options_225 **SoT** · W93 underneath held · **3 defaults frozen** · near-groups **parallel** · human main **NOT selected** · **GO deferred** · Mass/READY/Phase7/ops GO **NO-GO/未宣言/OFF/未宣言** · continuous paper **UNARMED** · COMPLETE **22** held · DEFER **4** · **no invent** · **no Mass/READY ON** · **no operational GO** · **no live** · **no simple_daily_sign mass** · **no hold/mom/frac grid** · **no synthetic-as-final** · proofs [`w0818d_w94_opt_skew_thick_20260818.md`](proof/w0818d_w94_opt_skew_thick_20260818.md) · [`w0818d_w94_residual_close_20260818.md`](proof/w0818d_w94_residual_close_20260818.md)  
**Repo tip:** `9b93f937232de572f72f7f880560975ff20efcb2` — W94 residual tip pin to latest post-pin HEAD · COMPLETE **22** / DEFER **4** / Mass/READY/ops GO **NO-GO/未宣言/未宣言** · continuous paper **UNARMED** · 3 defaults **frozen** · projection **FRESH**

## Research entry (W74 · … · W90 · real CF + Nikkei vol proxy W91 · options_225 BaseVol/ATM SoT W92 · BaseVol↔ATM differential W93 · skew/CM-term/ΔBaseVol + thick W94)
...
**GO final gates:** [`docs/proof/w0816u_w86_go_gates_20260817.md`](proof/w0816u_w86_go_gates_20260817.md) · GO = **pre-live-order final gate** · **repo + compare table required before GO consideration** · operational GO **未宣言** · **W94 GO judgment deferred**  
**Status:** research entry **linked** under COMPLETE **22** · Mass/READY/Phase7/operational GO **NO-GO/未宣言/OFF/未宣言** · factory = **logic diversification** + **real CF multi-year mass-eval** + **options_225 skew/CM-term/ΔBaseVol (canonical BaseVol level)** + **thick rate/flow/fund/mf** + **index vol proxy** (not grid mass · not Mass ON) · **3 default production research_candidates frozen** (xs hold=10 mom=5 · xs hold=10 mom=3 · fund hold=10 mom=10; **not retuned this wave**; **not** Mass/READY) · factory survivors **≠** production research_candidate · StrategySpec **v3** · continuous paper **UNARMED**
