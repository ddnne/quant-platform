...
- **mid_n_explore** (ADV 80): `eval-cf-dp-mid80-adopt2d-20260824d`, `eval-cf-dp-both-sleeves-20260823q-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-liq100-adopt2d-20260824d`, `eval-cf-dp-both-sleeves-20260823q-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v32-propose-polar-sparse` (`e7bb8818-df73-42a5-a072-2b2c416e5d76`). Baskets `eval-cf-dp-both-sleeves-20260823q` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 13. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824d`. Inventory `eval-inventory-bias-20260824d`. Propose 24d clone 1 / flatten+eps_down band / invert+roe_low empty parked. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py`.
