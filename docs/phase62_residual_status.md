...
- **mid_n_explore** (ADV 80): `eval-cf-dp-basket-alts-20260824dq-mid_n_explore`
- **liq_large** (ADV 100): `eval-cf-dp-basket-alts-20260824dq-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v138-24do-plus22` (`cce6b7e3-3d1c-497c-bc2e-2bf89ddc3c8a`). Baskets keep `eval-cf-dp-both-sleeves-20260824df` (`eval-basket-decision-20260824dq` fund×event + 24do-vol + theme_repo alts mid/liq 72/72; min lo below flow 4th 0.426). invert sleeve stays primary=False, thicker than theme_repo 3m, not mixed. Cost/risk `eval-usable-cost-risk-20260824dq` not_a_pass. Usable `eval-usable-inventory-20260824dq` n_usable 1724. usable-read/v3 n_ands+pri_series. event 3-AND +N **stopped**. Combo jsonl `eval-combo-jsonl-20260824dq` yaml_remains_sot. Deleted 12 uncited w0815 proofs. Propose `eval-cf-propose-20260824dq` n_adoptable 1 not written (missing 2-AND parents). unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
