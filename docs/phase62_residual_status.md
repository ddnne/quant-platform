...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824aw-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824aw-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v73-24aw-np-tight` (`c2ad6204-8b97-482b-bcd3-90e1003a5f96`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 18. Thin sleeve exclude. Occupancy `eval-occupancy-audit-20260824aw` (np×tight ~0.081 thin not sleeve; np×invert ~0.184; eps×sales ~0.287 flatten_eps band, no sleeve swap). Inventory `eval-inventory-bias-20260824ai`. Propose 24aw: adopt `event_np_negative_tight_funding` occupancy-equal thin. GOOD rotated invert×price. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
