...
- **mid_n_explore** (ADV 80): `eval-occupancy-audit-20260824bh-mid_n_explore`, `eval-cf-dp-both-sleeves-20260824e-mid_n_explore`
- **liq_large** (ADV 100): `eval-occupancy-audit-20260824bh-liq_large`, `eval-cf-dp-both-sleeves-20260824e-liq_large`
Universe `adv_desc_skip_missing_bars_and_fins` (head-N forbidden). Worker `research-mass-eval/v83-24bh-flatten-eps-np` (`17dd1643-a403-4d85-b537-8a1361826134`). Baskets `eval-cf-dp-both-sleeves-20260824e` not_a_pass. Durability `eval-durability-summary-20260823r` not_a_pass. Parked-empty YAML must have a SPARSE_GATE_COMBOS subset. near_empty park 21. Thin sleeve exclude 20. Occupancy `eval-occupancy-audit-20260824bh` (flatten×eps×np ~0.120/0.127 material, below flatten_eps ~0.28, no sleeve swap). Inventory `eval-inventory-bias-20260824ai`. Propose 24bh: adopt `event_flatten_eps_np_neg` occupancy-equal material. GOOD rotated flatten×eps×sales. unique22 5/17. GO deferred. HOLD: cost_models / options_225 / daily_path leftover / unique22 park YAML / CLI `__main__.py` / `ingestion.jsda.adapters` / `jquants/bulk.py`.
