...
- [`workers/research-mass-eval/`](workers/research-mass-eval/README.md) — W90 multi-logic
  lite multi-period mass-eval（`POST /v1/mass-eval` → R2 `research/mass_eval/job={id}/`）。
  Research only · Mass/READY/GO 未武装 · pure TS。
