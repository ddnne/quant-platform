...
R2_IO_PATH = _RESEARCH_PKG / "r2_io.py"
COMPLETE21_PATH = _RESEARCH_PKG / "complete21.py"
R2_FEATURE_CONTEXT_PATH = _RESEARCH_PKG / "r2_feature_context.py"
DAILY_PATH_EVAL_PATH = _RESEARCH_PKG / "daily_path_eval.py"
HARNESS_MODULE_PATHS = (
    EVAL_HARNESS_PATH,
    R2_IO_PATH,
    COMPLETE21_PATH,
    R2_FEATURE_CONTEXT_PATH,
    DAILY_PATH_EVAL_PATH,
)
HARNESS_AST_PATHS = HARNESS_MODULE_PATHS
