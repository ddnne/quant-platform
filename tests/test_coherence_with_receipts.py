    ...
    for i, segment in enumerate(required_segments):
        receipt = CollectionReceipt(
            ...
            digests=_signed_digests(
                ...
                raw_count=1 if segment.expected_items != 0 else 0,
                structured_count=1 if segment.expected_items != 0 else 0,
                ...
                expected_scope=segment.expected_scope,
                expected_items=segment.expected_items,
                observed_items=1 if segment.expected_items != 0 else 0,
                raw_page_count=1,
            ),
            run_id=1,
            status="SUCCESS",
