...
開発担当とレビューの役割は [AGENTS.md](AGENTS.md) に従います。時刻・PIT・保存・信頼境界は [docs/architecture.md](docs/architecture.md)、残作業の順は [docs/roadmap.md](docs/roadmap.md) です。古いフェーズ成功表は Git と ADR に残し、ここには現行経路だけを書きます。
