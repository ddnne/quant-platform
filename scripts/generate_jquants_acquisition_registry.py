...
OUTPUT = ROOT / "platform/workers/ingestion-secrets/src/generated/jquants_acquisition_registry.ts"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not OUTPUT.is_file() or OUTPUT.read_text(encoding="utf-8") != rendered:
        print("J-Quants acquisition registry drift; review and run scripts/generate_jquants_acquisition_registry.py --write")
        return 1
